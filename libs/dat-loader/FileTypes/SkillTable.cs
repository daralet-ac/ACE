...
public class SkillTable : FileType
{
    ...
    public void AddRetiredSkills()
    {
        SkillBaseHash.Add(
            (int)Skill.Awareness,
            new SkillBase(new SkillFormula(PropertyAttribute.Undef, PropertyAttribute.Undef, 1))
        );
        SkillBaseHash.Add(
            (int)Skill.Axe,
            new SkillBase(new SkillFormula(PropertyAttribute.Strength, PropertyAttribute.Coordination, 3))
        );
        SkillBaseHash.Add(
            (int)Skill.Crossbow,
            new SkillBase(new SkillFormula(PropertyAttribute.Coordination, PropertyAttribute.Undef, 2))
        );
        SkillBaseHash.Add(
            (int)Skill.Mace,
            new SkillBase(new SkillFormula(PropertyAttribute.Strength, PropertyAttribute.Coordination, 3))
