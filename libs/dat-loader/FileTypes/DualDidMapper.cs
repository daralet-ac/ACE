...
public class DualDidMapper : FileType
{
    ...
    public override void Unpack(BinaryReader reader)
    {
        ...
        var numClientEnumToIDs = reader.ReadCompressedUInt32();
        ...
        var numClientEnumToNames = reader.ReadCompressedUInt32();
        ...
        var numServerEnumToIDs = reader.ReadCompressedUInt32();
        ...
        var numServerEnumToNames = reader.ReadCompressedUInt32();
