...
public class EnvCell : FileType
{
    ...
    public override void Unpack(BinaryReader reader)
    {
        ...
        var numSurfaces = reader.ReadByte();
        var numPortals = reader.ReadByte(); // Note that "portal" in this context does not refer to the swirly pink/purple thing, its basically connecting cells
        var numStabs = reader.ReadUInt16(); // I believe this is what cells can be seen from this one. So the engine knows what else it needs to load/draw.
