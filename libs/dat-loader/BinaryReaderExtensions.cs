...
static class BinaryReaderExtensions
{
    ...
    public static void AlignBoundary(this BinaryReader reader)
    {
        ...
        var alignDelta = reader.BaseStream.Position % 4;
    ...
    public static string ReadPString(this BinaryReader reader, uint sizeOfLength = 2)
    {
        ...
        var thestring = reader.ReadBytes(stringlength);
    ...
    {
        var stringLength = reader.ReadCompressedUInt32();
        var thestring = "";
        for (var i = 0; i < stringLength; i++)
        {
            var myChar = reader.ReadUInt16();
