...
public static class PropertiesBookPageDataExtensions
{
    ...
    public static List<PropertiesBookPageData> Clone(
        this IList<PropertiesBookPageData> value,
    ...
    public static PropertiesBookPageData GetPage(
        this IList<PropertiesBookPageData> value,
        int index,
        ReaderWriterLockSlim rwLock
    )
