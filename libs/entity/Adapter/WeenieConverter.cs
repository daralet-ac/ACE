...
{
    public static Biota ConvertToBiota(
        this Weenie weenie,
        uint id,
        bool instantiateEmptyCollections = false,
        bool referenceWeenieCollectionsForCommonProperties = false
    )
    {
        ...
        if (weenie.PropertiesPosition != null && (instantiateEmptyCollections || weenie.PropertiesPosition.Count > 0))
        {
            result.PropertiesPosition = new Dictionary<PositionType, PropertiesPosition>(
                weenie.PropertiesPosition.Count
            );
        ...
        if (
            weenie.PropertiesTextureMap != null
            && (instantiateEmptyCollections || weenie.PropertiesTextureMap.Count > 0)
        )
        {
        ...
        else
        {
            if (
                ...
                && (instantiateEmptyCollections || weenie.PropertiesCreateList.Count > 0)
            )
            {
            ...
            if (
                weenie.PropertiesEventFilter != null
                && (instantiateEmptyCollections || weenie.PropertiesEventFilter.Count > 0)
            )
            {
            ...
            if (
                weenie.PropertiesGenerator != null
                && (instantiateEmptyCollections || weenie.PropertiesGenerator.Count > 0)
            )
            {
        ...
        if (weenie.PropertiesAttribute != null && (instantiateEmptyCollections || weenie.PropertiesAttribute.Count > 0))
        {
            result.PropertiesAttribute = new Dictionary<PropertyAttribute, PropertiesAttribute>(
                weenie.PropertiesAttribute.Count
            );
        ...
        if (
            weenie.PropertiesAttribute2nd != null
            && (instantiateEmptyCollections || weenie.PropertiesAttribute2nd.Count > 0)
        )
        {
            result.PropertiesAttribute2nd = new Dictionary<PropertyAttribute2nd, PropertiesAttribute2nd>(
                weenie.PropertiesAttribute2nd.Count
            );
        ...
        {
            if (
                weenie.PropertiesBodyPart != null
                && (instantiateEmptyCollections || weenie.PropertiesBodyPart.Count > 0)
            )
            {
                result.PropertiesBodyPart = new Dictionary<CombatBodyPart, PropertiesBodyPart>(
                    weenie.PropertiesBodyPart.Count
                );
        ...
        if (
            weenie.PropertiesBookPageData != null
