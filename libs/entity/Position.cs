...
public class Position
{
    ...
    public uint CellX
    {
        get => landblockId.Raw >> 8 & 0xFF;
    }
    public uint CellY
    {
        get => landblockId.Raw & 0xFF;
    }

    public uint LandblockX
    {
        get => landblockId.Raw >> 24 & 0xFF;
    }
    public uint LandblockY
    {
        get => landblockId.Raw >> 16 & 0xFF;
    }
    public uint GlobalCellX
    {
        get => LandblockX * 8 + CellX;
    }
    public uint GlobalCellY
    {
        get => LandblockY * 8 + CellY;
    }
    ...
    {
        var qw = RotationW; // north
        var qz = RotationZ; // south
    ...
    public Position(float northSouth, float eastWest)
    {
        ...
        var xOffset = ((baseX & 7) * 24.0f) + 12;
        var yOffset = ((baseY & 7) * 24.0f) + 12;
    ...
    {
        var blockX = (byte)(baseX >> 3);
        var blockY = (byte)(baseY >> 3);
        var cellX = (byte)(baseX & 7);
        var cellY = (byte)(baseY & 7);

        var block = (uint)((blockX << 8) | blockY);
        var cell = (uint)((cellX << 3) | cellY);
