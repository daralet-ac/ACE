...
public static class CharacterOptionExtensions
{
    ...
    static CharacterOptionExtensions()
    {
        ...
        CharacterOptions1Attributes = vals.ToDictionary(
            o => o,
            o => o.GetAttributeOfType<CharacterOptions1Attribute>()
        );
        CharacterOptions2Attributes = vals.ToDictionary(
            o => o,
            o => o.GetAttributeOfType<CharacterOptions2Attribute>()
        );
    }
