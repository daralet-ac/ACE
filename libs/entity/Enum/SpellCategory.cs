...
public enum SpellCategory : uint
{
    ...
    ExtraPiercingResistanceRaising2 = 760,
    ExtraBludgeoningResistanceRaising2 = 761,
    ExtraAcidResistanceRaising2 = 762,
    ExtraFireResistanceRaising2 = 763,
    ExtraColdResistanceRaising2 = 764,
    ExtraLightningResistanceRaising2 = 765,
    ...
    GearRatingStrength = 774,
    GearRatingEndurance = 775,
    GearRatingCoordination = 776,
    GearRatingQuickness = 777,
    GearRatingFocus = 778,
    GearRatingSelf = 779,
    ...
    ClarityMend = 808,
    RoadRunBuff = 809,
    CookFoodMaxHealth = 810,
    CookFoodMaxStamina = 811,
    CookFoodMaxMana = 812,
    CookFoodStrength = 813,
    CookFoodEndurance = 814,
    CookFoodCoordination = 815,
    CookFoodQuickness = 816,
    CookFoodFocus = 817,
    CookFoodSelf = 818,
    AlchPotionHealthRegeneration = 819,
    AlchPotionStaminaRegeneration = 820,
    AlchPotionManaRegeneration = 821,
    AlchPotionArmorProtection = 822,
    AlchPotionWardProtection = 823,
    AlchPotionSlashingProtection = 824,
    AlchPotionPiercingProtection = 825,
    AlchPotionBludgeoningProtection = 826,
    AlchPotionAcidProtection = 827,
    AlchPotionFireProtection = 828,
    AlchPotionColdProtection = 829,
    AlchPotionLightningProtection = 830,
    AlchPotionHealOverTime = 831,
    AlchPotionStaminaOverTime = 832,
    AlchPotionManaOverTime = 833,
    AlchPotionCriticalChance = 834,
    AlchPotionCriticalDamage = 835,
    AlchPotionBloodDrinker = 836,
    AlchPotionHeartSeeker = 837,
    AlchPotionSwiftKiller = 838,
    AlchPotionSpiritDrinker = 839,
    AlchPotionDefender = 840,
    CookFoodJump = 841,
    CookFoodRun = 842,
