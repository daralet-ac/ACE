...
public static class WeenieConverter
{
    ...
    )
    {
        ...
        if (
            weenie.WeeniePropertiesBool != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesBool.Count > 0)
        )
        {
        ...
        if (
            weenie.WeeniePropertiesFloat != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesFloat.Count > 0)
        )
        {
        ...
        if (
            weenie.WeeniePropertiesInt64 != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesInt64.Count > 0)
        )
        {
        ...
        if (
            weenie.WeeniePropertiesString != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesString.Count > 0)
        )
        {
        ...
        if (
            weenie.WeeniePropertiesPosition != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesPosition.Count > 0)
        )
        {
            result.PropertiesPosition = new Dictionary<PositionType, PropertiesPosition>(
                weenie.WeeniePropertiesPosition.Count
            );
        ...
        if (
            weenie.WeeniePropertiesSpellBook != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesSpellBook.Count > 0)
        )
        {
        ...
        if (
            weenie.WeeniePropertiesAnimPart != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesAnimPart.Count > 0)
        )
        {
            ...
            {
                var newEntity = new PropertiesAnimPart { Index = record.Index, AnimationId = record.AnimationId, };
        ...
        if (
            weenie.WeeniePropertiesPalette != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesPalette.Count > 0)
        )
        {
        ...
        if (
            weenie.WeeniePropertiesTextureMap != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesTextureMap.Count > 0)
        )
        {
        ...
        if (
            weenie.WeeniePropertiesCreateList != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesCreateList.Count > 0)
        )
        {
        ...
        if (
            weenie.WeeniePropertiesEmote != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesEmote.Count > 0)
        )
        {
        ...
        if (
            weenie.WeeniePropertiesEventFilter != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesEventFilter.Count > 0)
        )
        {
        ...
        if (
            weenie.WeeniePropertiesGenerator != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesGenerator.Count > 0)
        )
        {
        ...
        if (
            weenie.WeeniePropertiesAttribute != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesAttribute.Count > 0)
        )
        {
            result.PropertiesAttribute = new Dictionary<PropertyAttribute, PropertiesAttribute>(
                weenie.WeeniePropertiesAttribute.Count
            );
        ...
        if (
            weenie.WeeniePropertiesAttribute2nd != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesAttribute2nd.Count > 0)
        )
        {
            result.PropertiesAttribute2nd = new Dictionary<PropertyAttribute2nd, PropertiesAttribute2nd>(
                weenie.WeeniePropertiesAttribute2nd.Count
            );
        ...
        if (
            weenie.WeeniePropertiesBodyPart != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesBodyPart.Count > 0)
        )
        {
            result.PropertiesBodyPart = new Dictionary<CombatBodyPart, PropertiesBodyPart>(
                weenie.WeeniePropertiesBodyPart.Count
            );
        ...
        if (
            weenie.WeeniePropertiesSkill != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesSkill.Count > 0)
        )
        {
        ...
        if (
            weenie.WeeniePropertiesBookPageData != null
            && (instantiateEmptyCollections || weenie.WeeniePropertiesBookPageData.Count > 0)
        )
        {
    ...
    public static Models.Shard.Biota ConvertToDatabaseBiota(ACE.Database.Models.World.Weenie weenie, uint id)
    {
        ...
        foreach (var value in weenie.WeeniePropertiesBool)
        {
            result.BiotaPropertiesBool.Add(
                new BiotaPropertiesBool
                {
                    ObjectId = result.Id,
                    Type = value.Type,
                    Value = value.Value,
        ...
        foreach (var value in weenie.WeeniePropertiesDID)
        {
            result.BiotaPropertiesDID.Add(
                new BiotaPropertiesDID
                {
                    ObjectId = result.Id,
                    Type = value.Type,
                    Value = value.Value,
        ...
        foreach (var value in weenie.WeeniePropertiesFloat)
        {
            result.BiotaPropertiesFloat.Add(
                new BiotaPropertiesFloat
                {
                    ObjectId = result.Id,
                    Type = value.Type,
                    Value = value.Value,
        ...
        foreach (var value in weenie.WeeniePropertiesIID)
        {
            result.BiotaPropertiesIID.Add(
                new BiotaPropertiesIID
                {
                    ObjectId = result.Id,
                    Type = value.Type,
                    Value = value.Value,
        ...
        foreach (var value in weenie.WeeniePropertiesInt64)
        {
            result.BiotaPropertiesInt64.Add(
                new BiotaPropertiesInt64
                {
                    ObjectId = result.Id,
                    Type = value.Type,
                    Value = value.Value,
        ...
        foreach (var value in weenie.WeeniePropertiesString)
        {
            result.BiotaPropertiesString.Add(
                new BiotaPropertiesString
                {
                    ObjectId = result.Id,
                    Type = value.Type,
                    Value = value.Value,
        ...
        {
            result.BiotaPropertiesPosition.Add(
        ...
        foreach (var value in weenie.WeeniePropertiesSpellBook)
        {
            result.BiotaPropertiesSpellBook.Add(
                new BiotaPropertiesSpellBook
                {
                    ObjectId = result.Id,
                    Spell = value.Spell,
        ...
        {
            result.BiotaPropertiesAnimPart.Add(
        ...
        {
            result.BiotaPropertiesPalette.Add(
        ...
        {
            result.BiotaPropertiesTextureMap.Add(
        ...
        {
            result.BiotaPropertiesCreateList.Add(
                new BiotaPropertiesCreateList
                {
                    ObjectId = result.Id,
        ...
        foreach (var value in weenie.WeeniePropertiesEventFilter)
        {
            result.BiotaPropertiesEventFilter.Add(
                new BiotaPropertiesEventFilter { ObjectId = result.Id, Event = value.Event, }
            );
        }

        foreach (var value in weenie.WeeniePropertiesGenerator)
        {
            result.BiotaPropertiesGenerator.Add(
                new BiotaPropertiesGenerator
                {
                    ObjectId = result.Id,
                    Probability = value.Probability,
                    WeenieClassId = value.WeenieClassId,
        ...
        {
            result.BiotaPropertiesAttribute.Add(
                new BiotaPropertiesAttribute
                {
                    ObjectId = result.Id,
                    Type = value.Type,
        ...
        {
            result.BiotaPropertiesAttribute2nd.Add(
        ...
        {
            result.BiotaPropertiesBodyPart.Add(
                new BiotaPropertiesBodyPart
                {
                    ObjectId = result.Id,
                    Key = value.Key,
                    DType = value.DType,
        ...
        {
            result.BiotaPropertiesSkill.Add(
        ...
        {
            result.BiotaPropertiesBookPageData.Add(
                new BiotaPropertiesBookPageData
                {
                    ObjectId = result.Id,
                    PageId = value.PageId,
