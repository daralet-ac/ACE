...
public static class BiotaConverter
{
    ...
    )
    {
        ...
        if (
            biota.BiotaPropertiesString != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesString.Count > 0)
        )
        {
        ...
        if (
            biota.BiotaPropertiesPosition != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesPosition.Count > 0)
        )
        {
            result.PropertiesPosition = new Dictionary<PositionType, PropertiesPosition>(
                biota.BiotaPropertiesPosition.Count
            );
        ...
        if (
            biota.BiotaPropertiesSpellBook != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesSpellBook.Count > 0)
        )
        {
        ...
        if (
            biota.BiotaPropertiesAnimPart != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesAnimPart.Count > 0)
        )
        {
        ...
        if (
            biota.BiotaPropertiesPalette != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesPalette.Count > 0)
        )
        {
        ...
        if (
            biota.BiotaPropertiesTextureMap != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesTextureMap.Count > 0)
        )
        {
        ...
        if (
            ...
            && (instantiateEmptyCollections || biota.BiotaPropertiesCreateList.Count > 0)
        )
        {
        ...
        if (
            biota.BiotaPropertiesEventFilter != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesEventFilter.Count > 0)
        )
        {
        ...
        if (
            biota.BiotaPropertiesGenerator != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesGenerator.Count > 0)
        )
        {
        ...
        if (
            biota.BiotaPropertiesAttribute != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesAttribute.Count > 0)
        )
        {
            result.PropertiesAttribute = new Dictionary<PropertyAttribute, PropertiesAttribute>(
                biota.BiotaPropertiesAttribute.Count
            );
        ...
        if (
            biota.BiotaPropertiesAttribute2nd != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesAttribute2nd.Count > 0)
        )
        {
            result.PropertiesAttribute2nd = new Dictionary<PropertyAttribute2nd, PropertiesAttribute2nd>(
                biota.BiotaPropertiesAttribute2nd.Count
            );
        ...
        if (
            biota.BiotaPropertiesBodyPart != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesBodyPart.Count > 0)
        )
        {
            result.PropertiesBodyPart = new Dictionary<CombatBodyPart, PropertiesBodyPart>(
                biota.BiotaPropertiesBodyPart.Count
            );
        ...
        if (
            biota.BiotaPropertiesBookPageData != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesBookPageData.Count > 0)
        )
        {
        ...
        if (
            biota.BiotaPropertiesAllegiance != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesAllegiance.Count > 0)
        )
        {
            result.PropertiesAllegiance = new Dictionary<uint, PropertiesAllegiance>(
                biota.BiotaPropertiesAllegiance.Count
            );
        ...
        if (
            biota.BiotaPropertiesEnchantmentRegistry != null
            && (instantiateEmptyCollections || biota.BiotaPropertiesEnchantmentRegistry.Count > 0)
        )
        {
    ...
    )
    {
        ...
        if (biota.PropertiesPosition != null)
        {
            foreach (var kvp in biota.PropertiesPosition)
            {
                var entity = new BiotaPropertiesPosition
                {
                    ...
                    ObjCellId = kvp.Value.ObjCellId,
                    OriginX = kvp.Value.PositionX,
                    OriginY = kvp.Value.PositionY,
                    OriginZ = kvp.Value.PositionZ,
                    AnglesW = kvp.Value.RotationW,
                    AnglesX = kvp.Value.RotationX,
                    AnglesY = kvp.Value.RotationY,
                    AnglesZ = kvp.Value.RotationZ
                };
                ...
                if (
                    float.IsNaN(entity.AnglesX)
                    || float.IsNaN(entity.AnglesY)
                    || float.IsNaN(entity.AnglesZ)
                    || float.IsNaN(entity.AnglesW)
                )
                {
                    entity.AnglesW = 1;
                    entity.AnglesX = 0;
        ...
        {
            for (var i = 0; i < biota.PropertiesAnimPart.Count; i++)
            {
        ...
        {
            for (var i = 0; i < biota.PropertiesPalette.Count; i++)
            {
        ...
        {
            for (var i = 0; i < biota.PropertiesTextureMap.Count; i++)
            {
        ...
        if (biota.PropertiesAttribute != null)
        {
            foreach (var kvp in biota.PropertiesAttribute)
            {
                var entity = new BiotaPropertiesAttribute
                {
                    ...
                    LevelFromCP = kvp.Value.LevelFromCP,
                    CPSpent = kvp.Value.CPSpent
                };
        ...
        if (biota.PropertiesAllegiance != null)
        {
            foreach (var kvp in biota.PropertiesAllegiance)
            {
                ...
                {
                    AllegianceId = biota.Id,
                    CharacterId = kvp.Key,
                    Banned = kvp.Value.Banned,
                    ApprovedVassal = kvp.Value.ApprovedVassal
                };
