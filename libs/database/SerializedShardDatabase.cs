...
public class SerializedShardDatabase
{
    ...
    public void SaveBiotasInParallel(
    ...
    public void RemoveBiotasInParallel(
        IEnumerable<uint> ids,
        Action<bool> callback,
        Action<TimeSpan, TimeSpan> performanceResults
    )
    {
        var initialCallTime = DateTime.UtcNow;
    ...
    public void GetBankInventoryInParallel(
        uint storageId,
        uint parentId,
        bool includedNestedItems,
        Action<List<Biota>> callback
    )
    {
        _queue.Add(
            new Task(() =>
    ...
    public void AddCharacterInParallel(
    ...
    )
    {
        _queue.Add(
            new Task(() =>
            {
                var result = BaseDatabase.AddCharacterInParallel(
                    biota,
                    biotaLock,
                    possessions,
                    character,
