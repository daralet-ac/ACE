...
public static class CharacterExtensions
{
    ...
    public static List<CharacterPropertiesContractRegistry> GetContracts(
    ...
    public static CharacterPropertiesContractRegistry GetContract(
        this Character character,
        uint contractId,
        ReaderWriterLockSlim rwLock
    )
    ...
    public static CharacterPropertiesContractRegistry GetOrCreateContract(
        this Character character,
        uint contractId,
        ReaderWriterLockSlim rwLock,
        out bool contractWasCreated
    )
    {
        ...
        try
        {
            ...
            if (entity == null)
            {
                entity = new CharacterPropertiesContractRegistry { ContractId = contractId };
    ...
    public static bool EraseContract(
        this Character character,
        uint contractId,
        out CharacterPropertiesContractRegistry contractErased,
        ReaderWriterLockSlim rwLock
    )
    {
        rwLock.EnterWriteLock();
        try
        {
            contractErased = character.CharacterPropertiesContractRegistry.FirstOrDefault(c =>
    ...
    public static void EraseAllContracts(
        this Character character,
        out List<CharacterPropertiesContractRegistry> contractsErased,
        ReaderWriterLockSlim rwLock
    )
    {
        rwLock.EnterWriteLock();
    ...
    public static CharacterPropertiesFillCompBook GetFillComponent(
        this Character character,
        uint wcid,
        ReaderWriterLockSlim rwLock
    )
    ...
    public static List<CharacterPropertiesFillCompBook> GetFillComponents(
        this Character character,
        ReaderWriterLockSlim rwLock
    )
    {
    ...
    public static CharacterPropertiesFillCompBook AddFillComponent(
        this Character character,
        uint wcid,
        uint amount,
        ReaderWriterLockSlim rwLock,
        ...
        try
        {
            ...
            try
            {
                entity = new CharacterPropertiesFillCompBook
                {
                    ...
                    SpellComponentId = (int)wcid,
                    QuantityToRebuy = (int)amount
                };
    ...
    public static bool TryRemoveFillComponent(
        this Character character,
        uint wcid,
        out CharacterPropertiesFillCompBook entity,
        ReaderWriterLockSlim rwLock
    )
    {
        rwLock.EnterUpgradeableReadLock();
    ...
    public static CharacterPropertiesFriendList AddFriend(
        this Character character,
        uint friendId,
        ReaderWriterLockSlim rwLock,
        out bool friendAlreadyExists
    )
    {
        rwLock.EnterUpgradeableReadLock();
        try
    ...
    public static bool TryRemoveFriend(
        this Character character,
        uint friendId,
        out CharacterPropertiesFriendList entity,
        ReaderWriterLockSlim rwLock
    )
    {
        rwLock.EnterUpgradeableReadLock();
    ...
    public static List<CharacterPropertiesQuestRegistry> GetQuests(
        this Character character,
        ReaderWriterLockSlim rwLock
    )
    {
    ...
    public static CharacterPropertiesQuestRegistry GetQuest(
        this Character character,
        string questName,
        ReaderWriterLockSlim rwLock
    )
    {
        ...
        try
        {
            return character.CharacterPropertiesQuestRegistry.FirstOrDefault(q =>
    ...
    public static CharacterPropertiesQuestRegistry GetOrCreateQuest(
        this Character character,
        string questName,
        ReaderWriterLockSlim rwLock,
        out bool questRegistryWasCreated
    )
    {
        rwLock.EnterWriteLock();
        try
        {
            var entity = character.CharacterPropertiesQuestRegistry.FirstOrDefault(q =>
                q.QuestName.Equals(questName, StringComparison.OrdinalIgnoreCase)
            );

            if (entity == null)
            {
                entity = new CharacterPropertiesQuestRegistry { QuestName = questName };
    ...
    public static void EraseAllQuests(
        this Character character,
        out List<string> questNamesErased,
        ReaderWriterLockSlim rwLock
    )
    {
        rwLock.EnterWriteLock();
    ...
    public static List<CharacterPropertiesShortcutBar> GetShortcuts(
        this Character character,
        ReaderWriterLockSlim rwLock
    )
    {
    ...
    public static void AddOrUpdateShortcut(
        this Character character,
        uint index,
        uint objectId,
        ReaderWriterLockSlim rwLock
        ...
        try
        {
            ...
            try
            {
                if (entity == null)
                {
                    ...
                    {
                        CharacterId = character.Id,
                        ShortcutObjectId = objectId,
                        ShortcutBarIndex = index + 1,
                        Character = character
                    };
    ...
    public static bool TryRemoveShortcut(
        this Character character,
        uint index,
        out CharacterPropertiesShortcutBar entity,
        ReaderWriterLockSlim rwLock
    )
    {
        rwLock.EnterUpgradeableReadLock();
    ...
    public static List<CharacterPropertiesSpellBar> GetSpellsInBar(
        this Character character,
        int barNumber,
        ReaderWriterLockSlim rwLock
    )
    {
        ...
        {
            return character
                .CharacterPropertiesSpellBar.Where(x => x.SpellBarNumber == barNumber + 1)
    ...
    /// </summary>
    public static bool AddSpellToBar(
        this Character character,
        uint barNumber,
        uint indexInBar,
        uint spell,
    ...
    )
    {
        ...
        try
        {
            var entity = character.CharacterPropertiesSpellBar.FirstOrDefault(x =>
                x.SpellBarNumber == barNumber + 1 && x.SpellId == spell
            );
            if (entity == null)
            {
                rwLock.EnterWriteLock();
                try
                {
                    var spellCountInThisBar = character.CharacterPropertiesSpellBar.Count(x =>
                        x.SpellBarNumber == barNumber + 1
                    );
                    ...
                    entity = new CharacterPropertiesSpellBar
                    {
                        CharacterId = character.Id,
                        SpellBarNumber = barNumber + 1,
                        SpellBarIndex = indexInBar + 1,
                        SpellId = spell,
                        Character = character
                    };
    ...
    /// </summary>
    public static bool TryRemoveSpellFromBar(
        this Character character,
        uint barNumber,
        uint spell,
        out CharacterPropertiesSpellBar entity,
        ReaderWriterLockSlim rwLock
    )
    {
        rwLock.EnterUpgradeableReadLock();
        try
        {
            ...
            entity = character.CharacterPropertiesSpellBar.FirstOrDefault(x =>
                x.SpellBarNumber == barNumber + 1 && x.SpellId == spell
            );
            if (entity != null)
            {
    ...
    public static void AddOrUpdateSquelch(
        this Character character,
        uint squelchCharacterId,
        uint squelchAccountId,
        uint type,
        ReaderWriterLockSlim rwLock
    )
    {
        ...
        try
        {
            var entity = character.CharacterPropertiesSquelch.FirstOrDefault(x =>
            ...
            try
            {
                if (entity == null)
                {
                    ...
                    {
                        CharacterId = character.Id,
                        SquelchCharacterId = squelchCharacterId,
                        SquelchAccountId = squelchAccountId,
                        Type = type,
                        Character = character
                    };
    ...
    public static bool TryRemoveSquelch(
        this Character character,
        uint squelchCharacterId,
        uint squelchAccountId,
        out CharacterPropertiesSquelch entity,
        ReaderWriterLockSlim rwLock
    )
    {
        rwLock.EnterUpgradeableReadLock();
        try
        {
            entity = character.CharacterPropertiesSquelch.FirstOrDefault(x =>
                x.SquelchCharacterId == squelchCharacterId && x.SquelchAccountId == squelchAccountId
            );
    ...
    public static void AddTitleToRegistry(
        this Character character,
        uint title,
        ReaderWriterLockSlim rwLock,
        out bool titleAlreadyExists,
        out int numCharacterTitles
    )
    {
        rwLock.EnterUpgradeableReadLock();
        try
        {
            ...
            try
            {
                entity = new CharacterPropertiesTitleBook
                {
                    CharacterId = character.Id,
                    TitleId = title,
                    Character = character
