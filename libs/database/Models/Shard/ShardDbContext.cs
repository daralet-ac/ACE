...
public partial class ShardDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Biota>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Object Id within the Shard");
            ...
            entity.Property(e => e.WeenieType).HasColumnName("weenie_Type").HasComment("WeenieType for this Object");
        });
        ...
        modelBuilder.Entity<BiotaPropertiesEmoteAction>(entity =>
        {
            ...
            entity.Property(e => e.Extent).HasColumnName("extent").HasComment("?");
        ...
        modelBuilder.Entity<BiotaPropertiesEnchantmentRegistry>(entity =>
        {
            ...
            entity.Property(e => e.SpellId).HasColumnName("spell_Id").HasComment("Id of Spell");
            ...
            entity.Property(e => e.LayerId).HasColumnName("layer_Id").HasComment("Id of Layer");

            entity.Property(e => e.DegradeLimit).HasColumnName("degrade_Limit").HasComment("???");

            entity.Property(e => e.DegradeModifier).HasColumnName("degrade_Modifier").HasComment("???");

            entity.Property(e => e.Duration).HasColumnName("duration").HasComment("the duration of the spell");
            ...
            entity.Property(e => e.HasSpellSetId).HasColumnName("has_Spell_Set_Id").HasComment("Has Spell Set Id?");
            ...
            entity.Property(e => e.PowerLevel).HasColumnName("power_Level").HasComment("Power Level of Spell");

            entity.Property(e => e.SpellCategory).HasColumnName("spell_Category").HasComment("Category of Spell");
            ...
            entity.Property(e => e.StatModValue).HasColumnName("stat_Mod_Value").HasComment("the effect value/amount");
        ...
        modelBuilder.Entity<BiotaPropertiesSpellBook>(entity =>
        {
            ...
            entity.Property(e => e.Probability).HasColumnName("probability").HasComment("Chance to cast this spell");
        ...
        modelBuilder.Entity<Character>(entity =>
        {
            ...
            entity.Property(e => e.IsDeleted).HasColumnName("is_Deleted").HasComment("Is this Character deleted?");
            ...
            entity.Property(e => e.Name).IsRequired().HasColumnName("name").HasComment("Name of Character");

            entity.Property(e => e.SpellbookFilters).HasColumnName("spellbook_Filters").HasDefaultValueSql("'16383'");
        ...
        modelBuilder.Entity<CharacterPropertiesFriendList>(entity =>
        {
            ...
            entity.Property(e => e.FriendId).HasColumnName("friend_Id").HasComment("Id of Friend");
        ...
        modelBuilder.Entity<CharacterPropertiesQuestRegistry>(entity =>
        {
            ...
            entity.Property(e => e.QuestName).HasColumnName("quest_Name").HasComment("Unique Name of Quest");
        ...
        modelBuilder.Entity<CharacterPropertiesSpellBar>(entity =>
        {
            ...
            entity.Property(e => e.SpellBarNumber).HasColumnName("spell_Bar_Number").HasComment("Id of Spell Bar");
        ...
        modelBuilder.Entity<CharacterPropertiesTitleBook>(entity =>
        {
            ...
            entity.Property(e => e.TitleId).HasColumnName("title_Id").HasComment("Id of Title");
        ...
        modelBuilder.Entity<HousePermission>(entity =>
        {
            ...
            entity.Property(e => e.HouseId).HasColumnName("house_Id").HasComment("GUID of House Biota Object");
