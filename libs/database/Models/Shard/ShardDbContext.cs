...
public partial class ShardDbContext : DbContext
{
    ...
    public virtual DbSet<PlayerMarketTransaction> PlayerMarketTransactions { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Biota>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Object Id within the Shard").HasColumnName("id");
            entity
                .Property(e => e.PopulatedCollectionFlags)
            ...
            entity.Property(e => e.WeenieType).HasComment("WeenieType for this Object").HasColumnName("weenie_Type");
        });

        modelBuilder.Entity<BiotaPropertiesAllegiance>(entity =>
        {
            entity
                .HasKey(e => new { e.AllegianceId, e.CharacterId })
                .HasName("PRIMARY")
        ...
        {
            entity
                .HasKey(e => new { e.ObjectId, e.Type })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
        ...
        modelBuilder.Entity<BiotaPropertiesEmoteAction>(entity =>
        {
            ...
            entity.Property(e => e.Extent).HasComment("?").HasColumnName("extent");
        ...
        modelBuilder.Entity<BiotaPropertiesEnchantmentRegistry>(entity =>
        {
            ...
            entity.ToTable(
                ...
                tb => tb.HasComment("Enchantment Registry Properties of Weenies")
            );
            ...
            entity
                ...
                .HasComment("Id of the object this property belongs to")
                .HasColumnName("object_Id");
            entity.Property(e => e.SpellId).HasComment("Id of Spell").HasColumnName("spell_Id");
            entity
                .Property(e => e.CasterObjectId)
                .HasComment("Id of the object that cast this spell")
                .HasColumnName("caster_Object_Id");
            entity.Property(e => e.LayerId).HasComment("Id of Layer").HasColumnName("layer_Id");
            entity.Property(e => e.DegradeLimit).HasComment("???").HasColumnName("degrade_Limit");
            entity.Property(e => e.DegradeModifier).HasComment("???").HasColumnName("degrade_Modifier");
            entity.Property(e => e.Duration).HasComment("the duration of the spell").HasColumnName("duration");
            entity
                .Property(e => e.EnchantmentCategory)
                .HasComment("Which PackableList this Enchantment goes in (enchantmentMask)")
                .HasColumnName("enchantment_Category");
            entity.Property(e => e.HasSpellSetId).HasComment("Has Spell Set Id?").HasColumnName("has_Spell_Set_Id");
            entity
                .Property(e => e.LastTimeDegraded)
                .HasComment("the time when this enchantment was cast")
                .HasColumnName("last_Time_Degraded");
            entity.Property(e => e.PowerLevel).HasComment("Power Level of Spell").HasColumnName("power_Level");
            entity.Property(e => e.SpellCategory).HasComment("Category of Spell").HasColumnName("spell_Category");
            entity
                .Property(e => e.SpellSetId)
        ...
        {
            entity
                .HasKey(e => new { e.ObjectId, e.Event })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
        ...
        {
            entity
                .HasKey(e => new { e.ObjectId, e.PositionType })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
        ...
        {
            entity
                .HasKey(e => new { e.ObjectId, e.Spell })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
            ...
            entity.Property(e => e.Probability).HasComment("Chance to cast this spell").HasColumnName("probability");
        ...
        modelBuilder.Entity<Character>(entity =>
        {
            ...
            entity
                .Property(e => e.DeleteTime)
                .HasComment("The character will be marked IsDeleted=True after this timestamp")
                .HasColumnName("delete_Time");
            entity.Property(e => e.GameplayOptions).HasColumnType("blob").HasColumnName("gameplay_Options");
            entity.Property(e => e.HairTexture).HasColumnName("hair_Texture");
            entity.Property(e => e.IsDeleted).HasComment("Is this Character deleted?").HasColumnName("is_Deleted");
            entity.Property(e => e.IsPlussed).HasColumnName("is_Plussed");
            entity
                .Property(e => e.LastLoginTimestamp)
                .HasComment("Timestamp the last time this character entered the world")
                .HasColumnName("last_Login_Timestamp");
            entity.Property(e => e.Name).IsRequired().HasComment("Name of Character").HasColumnName("name");
            entity.Property(e => e.SpellbookFilters).HasDefaultValueSql("'16383'").HasColumnName("spellbook_Filters");
        ...
        {
            entity
                .HasKey(e => new { e.CharacterId, e.ContractId })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
        ...
        {
            entity
                .HasKey(e => new { e.CharacterId, e.SpellComponentId })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });

            entity.ToTable(
                "character_properties_fill_comp_book",
                tb => tb.HasComment("FillCompBook Properties of Weenies")
            );
        ...
        modelBuilder.Entity<CharacterPropertiesFriendList>(entity =>
        {
            ...
            entity
                ...
                .HasComment("Id of the character this property belongs to")
                .HasColumnName("character_Id");
            entity.Property(e => e.FriendId).HasComment("Id of Friend").HasColumnName("friend_Id");
        ...
        {
            entity
                .HasKey(e => new { e.CharacterId, e.QuestName })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });

            entity.ToTable(
                "character_properties_quest_registry",
                tb => tb.HasComment("QuestBook Properties of Weenies")
            );
            ...
            entity
                ...
                .HasComment("Id of the character this property belongs to")
                .HasColumnName("character_Id");
            entity.Property(e => e.QuestName).HasComment("Unique Name of Quest").HasColumnName("quest_Name");
            entity
                .Property(e => e.LastTimeCompleted)
                .HasComment("Timestamp of last successful completion")
                .HasColumnName("last_Time_Completed");
            entity
                .Property(e => e.NumTimesCompleted)
        ...
        {
            entity
                .HasKey(e => new { e.CharacterId, e.ShortcutBarIndex })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });

            entity.ToTable(
                "character_properties_shortcut_bar",
                tb => tb.HasComment("ShortcutBar Properties of Weenies")
            );
        ...
        modelBuilder.Entity<CharacterPropertiesSpellBar>(entity =>
        {
            ...
            entity
                ...
                .HasComment("Id of the character this property belongs to")
                .HasColumnName("character_Id");
            entity.Property(e => e.SpellBarNumber).HasComment("Id of Spell Bar").HasColumnName("spell_Bar_Number");
            entity
                .Property(e => e.SpellId)
                .HasComment("Id of Spell on this Spell Bar at this Slot")
                .HasColumnName("spell_Id");
            entity
                .Property(e => e.SpellBarIndex)
        ...
        {
            entity
                .HasKey(e => new { e.CharacterId, e.SquelchCharacterId })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
        ...
        modelBuilder.Entity<CharacterPropertiesTitleBook>(entity =>
        {
            ...
            entity
                ...
                .HasComment("Id of the character this property belongs to")
                .HasColumnName("character_Id");
            entity.Property(e => e.TitleId).HasComment("Id of Title").HasColumnName("title_Id");
        ...
        modelBuilder.Entity<ConfigPropertiesString>(entity =>
        {
            ...
            entity.Property(e => e.Key).HasColumnName("key");
            entity.Property(e => e.Description).HasColumnType("text").HasColumnName("description");
            entity.Property(e => e.Value).IsRequired().HasColumnType("text").HasColumnName("value");
        });

        modelBuilder.Entity<HousePermission>(entity =>
        {
            entity
                .HasKey(e => new { e.HouseId, e.PlayerGuid })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
            ...
            entity.Property(e => e.HouseId).HasComment("GUID of House Biota Object").HasColumnName("house_Id");
            entity
