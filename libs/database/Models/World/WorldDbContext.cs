...
public partial class WorldDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CookBook>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Id of this cook book instance");
            ...
            entity.Property(e => e.RecipeId).HasColumnName("recipe_Id").HasComment("Unique Id of Recipe");
        ...
        modelBuilder.Entity<Encounter>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Id of this Encounter");

            entity.Property(e => e.CellX).HasColumnName("cell_X").HasComment("CellX position of this Encounter");

            entity.Property(e => e.CellY).HasColumnName("cell_Y").HasComment("CellY position of this Encounter");

            entity.Property(e => e.Landblock).HasColumnName("landblock").HasComment("Landblock for this Encounter");
        ...
        modelBuilder.Entity<Event>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Id of this Event");
            ...
            entity.Property(e => e.Name).IsRequired().HasColumnName("name").HasComment("Unique Event of Quest");
            ...
            entity.Property(e => e.State).HasColumnName("state").HasComment("State of Event (GameEventState)");
        });
        ...
        modelBuilder.Entity<HousePortal>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Id of this House Portal");
            ...
            entity.Property(e => e.HouseId).HasColumnName("house_Id").HasComment("Unique Id of House");
        ...
        modelBuilder.Entity<LandblockInstance>(entity =>
        {
            ...
            entity.Property(e => e.Guid).HasColumnName("guid").HasComment("Unique Id of this Instance");
        ...
        modelBuilder.Entity<LandblockInstanceLink>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Id of this Instance Link");

            entity.Property(e => e.ChildGuid).HasColumnName("child_GUID").HasComment("GUID of child instance");
            ...
            entity.Property(e => e.ParentGuid).HasColumnName("parent_GUID").HasComment("GUID of parent instance");
        ...
        modelBuilder.Entity<PointsOfInterest>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Id of this POI");
        ...
        modelBuilder.Entity<Quest>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Id of this Quest");
            ...
            entity.Property(e => e.Name).IsRequired().HasColumnName("name").HasComment("Unique Name of Quest");
        });
        ...
        modelBuilder.Entity<Recipe>(entity =>
        {
            ...
            entity.Property(e => e.Id).ValueGeneratedNever().HasColumnName("id").HasComment("Unique Id of this Recipe");
        ...
        modelBuilder.Entity<RecipeMod>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Id of this Recipe Mod instance");
        ...
        modelBuilder.Entity<RecipeModsBool>(entity =>
        {
            ...
            entity.Property(e => e.RecipeModId).HasColumnName("recipe_Mod_Id").HasComment("Unique Id of Recipe Mod");
        ...
        modelBuilder.Entity<RecipeRequirementsBool>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Id of this Recipe Requirement instance");
        ...
        modelBuilder.Entity<Spell>(entity =>
        {
            ...
            entity.Property(e => e.Id).ValueGeneratedNever().HasColumnName("id").HasComment("Unique Id of this Spell");
        ...
        modelBuilder.Entity<TreasureDeath>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Id of this Treasure");
        ...
        modelBuilder.Entity<TreasureGemCount>(entity =>
        {
            ...
            entity.HasCharSet("utf16").UseCollation("utf16_general_ci");
        ...
        modelBuilder.Entity<TreasureMaterialBase>(entity =>
        {
            ...
            entity.Property(e => e.MaterialId).HasColumnName("material_Id").HasComment("MaterialType");

            entity.Property(e => e.Probability).HasColumnName("probability");

            entity.Property(e => e.Tier).HasColumnName("tier").HasComment("Loot Tier");
        });
        ...
        modelBuilder.Entity<TreasureMaterialGroups>(entity =>
        {
            ...
            entity.Property(e => e.MaterialGroup).HasColumnName("material_Group").HasComment("MaterialType Group");
        ...
        modelBuilder.Entity<TreasureWielded>(entity =>
        {
            ...
            entity.Property(e => e.Shade).HasColumnName("shade").HasComment("Shade of Object generated's Palette");
            ...
            entity.Property(e => e.Unknown1).HasColumnName("unknown_1").HasComment("Always 0 in cache.bin");

            entity.Property(e => e.Unknown10).HasColumnName("unknown_10").HasComment("Always 0 in cache.bin");

            entity.Property(e => e.Unknown11).HasColumnName("unknown_11").HasComment("Always 0 in cache.bin");

            entity.Property(e => e.Unknown12).HasColumnName("unknown_12").HasComment("Always 0 in cache.bin");

            entity.Property(e => e.Unknown3).HasColumnName("unknown_3").HasComment("Always 0 in cache.bin");

            entity.Property(e => e.Unknown4).HasColumnName("unknown_4").HasComment("Always 0 in cache.bin");

            entity.Property(e => e.Unknown5).HasColumnName("unknown_5").HasComment("Always 0 in cache.bin");

            entity.Property(e => e.Unknown9).HasColumnName("unknown_9").HasComment("Always 0 in cache.bin");
        ...
        modelBuilder.Entity<Weenie>(entity =>
        {
            ...
            entity.Property(e => e.Type).HasColumnName("type").HasComment("WeenieType");
        });
        ...
        modelBuilder.Entity<WeeniePropertiesAnimPart>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Id of this Property");
        ...
        modelBuilder.Entity<WeeniePropertiesAttribute>(entity =>
        {
            ...
            entity.Property(e => e.CPSpent).HasColumnName("c_P_Spent").HasComment("XP spent on this attribute");

            entity.Property(e => e.InitLevel).HasColumnName("init_Level").HasComment("innate points");

            entity.Property(e => e.LevelFromCP).HasColumnName("level_From_C_P").HasComment("points raised");
        ...
        modelBuilder.Entity<WeeniePropertiesBookPageData>(entity =>
        {
            ...
            entity.Property(e => e.AuthorId).HasColumnName("author_Id").HasComment("Id of the Author of this page");
            ...
            entity.Property(e => e.PageId).HasColumnName("page_Id").HasComment("Id of the page number for this page");
        ...
        modelBuilder.Entity<WeeniePropertiesBool>(entity =>
        {
            ...
            entity.Property(e => e.Value).HasColumnName("value").HasComment("Value of this Property");
        ...
        modelBuilder.Entity<WeeniePropertiesCreateList>(entity =>
        {
            ...
            entity.Property(e => e.Palette).HasColumnName("palette").HasComment("Palette Color of Object");

            entity.Property(e => e.Shade).HasColumnName("shade").HasComment("Shade of Object's Palette");
            ...
            entity.Property(e => e.TryToBond).HasColumnName("try_To_Bond").HasComment("Unused?");
        ...
        modelBuilder.Entity<WeeniePropertiesEmote>(entity =>
        {
            ...
            entity.Property(e => e.Category).HasColumnName("category").HasComment("EmoteCategory");
        ...
        modelBuilder.Entity<WeeniePropertiesEmoteAction>(entity =>
        {
            ...
            entity.Property(e => e.Extent).HasColumnName("extent").HasDefaultValueSql("'1'").HasComment("?");
            ...
            entity.Property(e => e.Order).HasColumnName("order").HasComment("Emote Action Sequence Order");
            ...
            entity.Property(e => e.Type).HasColumnName("type").HasComment("EmoteType");
        ...
        modelBuilder.Entity<WeeniePropertiesEventFilter>(entity =>
        {
            ...
            entity.Property(e => e.Event).HasColumnName("event").HasComment("Id of Event to filter");
        ...
        modelBuilder.Entity<WeeniePropertiesGenerator>(entity =>
        {
            ...
            entity.Property(e => e.Delay).HasColumnName("delay").HasComment("Amount of delay before generation");
            ...
            entity.Property(e => e.Probability).HasColumnName("probability").HasDefaultValueSql("'1'");

            entity.Property(e => e.Shade).HasColumnName("shade").HasComment("Shade of Object generated's Palette");

            entity.Property(e => e.StackSize).HasColumnName("stack_Size").HasComment("StackSize of object generated");
        ...
        modelBuilder.Entity<WeeniePropertiesPosition>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id").HasComment("Unique Id of this Position");
        ...
        modelBuilder.Entity<WeeniePropertiesSkill>(entity =>
        {
            ...
            entity.Property(e => e.LastUsedTime).HasColumnName("last_Used_Time").HasComment("time skill was last used");

            entity.Property(e => e.LevelFromPP).HasColumnName("level_From_P_P").HasComment("points raised");
            ...
            entity.Property(e => e.PP).HasColumnName("p_p").HasComment("XP spent on this skill");
            ...
            entity.Property(e => e.SAC).HasColumnName("s_a_c").HasComment("skill state");
        ...
        modelBuilder.Entity<WeeniePropertiesSpellBook>(entity =>
        {
            ...
            entity.Property(e => e.Spell).HasColumnName("spell").HasComment("Id of Spell");
