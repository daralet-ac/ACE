...
public partial class WorldDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            var connectionString =
                $"server={config.Host};port={config.Port};user={config.Username};password={config.Password};database={config.Database};{config.ConnectionOptions}";
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CookBook>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this cook book instance").HasColumnName("id");
            entity
            ...
            entity.Property(e => e.RecipeId).HasComment("Unique Id of Recipe").HasColumnName("recipe_Id");
            entity
                .Property(e => e.SourceWCID)
                .HasComment("Weenie Class Id of the source object for this recipe")
                .HasColumnName("source_W_C_I_D");
            entity
                .Property(e => e.TargetWCID)
        ...
        modelBuilder.Entity<Encounter>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Encounter").HasColumnName("id");
            entity.Property(e => e.CellX).HasComment("CellX position of this Encounter").HasColumnName("cell_X");
            entity.Property(e => e.CellY).HasComment("CellY position of this Encounter").HasColumnName("cell_Y");
            entity.Property(e => e.Landblock).HasComment("Landblock for this Encounter").HasColumnName("landblock");
            entity
                .Property(e => e.LastModified)
                .ValueGeneratedOnAddOrUpdate()
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
        ...
        modelBuilder.Entity<Event>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Event").HasColumnName("id");
            entity
            ...
            entity
                ...
                .HasColumnType("datetime")
                .HasColumnName("last_Modified");
            entity.Property(e => e.Name).IsRequired().HasComment("Unique Event of Quest").HasColumnName("name");
            entity
                .Property(e => e.StartTime)
                .HasDefaultValueSql("'-1'")
                .HasComment("Unixtime of Event Start")
                .HasColumnName("start_Time");
            entity.Property(e => e.State).HasComment("State of Event (GameEventState)").HasColumnName("state");
        });
        ...
        modelBuilder.Entity<HousePortal>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this House Portal").HasColumnName("id");
            ...
            entity.Property(e => e.HouseId).HasComment("Unique Id of House").HasColumnName("house_Id");
            entity
                .Property(e => e.LastModified)
                .ValueGeneratedOnAddOrUpdate()
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
        ...
        modelBuilder.Entity<LandblockInstance>(entity =>
        {
            ...
            entity.Property(e => e.Guid).HasComment("Unique Id of this Instance").HasColumnName("guid");
            entity.Property(e => e.AnglesW).HasColumnName("angles_W");
            entity.Property(e => e.AnglesX).HasColumnName("angles_X");
            entity.Property(e => e.AnglesY).HasColumnName("angles_Y");
            entity.Property(e => e.AnglesZ).HasColumnName("angles_Z");
            entity
                .Property(e => e.IsLinkChild)
                .HasComment("Is this a child link for any other instances?")
                .HasColumnName("is_Link_Child");
            entity
                .Property(e => e.Landblock)
        ...
        modelBuilder.Entity<LandblockInstanceLink>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Instance Link").HasColumnName("id");
            entity.Property(e => e.ChildGuid).HasComment("GUID of child instance").HasColumnName("child_GUID");
            entity
                .Property(e => e.LastModified)
                .ValueGeneratedOnAddOrUpdate()
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime")
                .HasColumnName("last_Modified");
            entity.Property(e => e.ParentGuid).HasComment("GUID of parent instance").HasColumnName("parent_GUID");
        ...
        modelBuilder.Entity<PointsOfInterest>(entity =>
        {
            ...
            entity
                .HasIndex(e => e.Name, "name_UNIQUE")
                .IsUnique()
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 100 });

            entity.Property(e => e.Id).HasComment("Unique Id of this POI").HasColumnName("id");
            entity
                .Property(e => e.LastModified)
                .ValueGeneratedOnAddOrUpdate()
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
        ...
        modelBuilder.Entity<Quest>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Quest").HasColumnName("id");
            entity
                .Property(e => e.LastModified)
                .ValueGeneratedOnAddOrUpdate()
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
            ...
            entity
                .Property(e => e.MinDelta)
                .HasComment("Minimum time between Quest completions")
                .HasColumnName("min_Delta");
            entity.Property(e => e.Name).IsRequired().HasComment("Unique Name of Quest").HasColumnName("name");
        });
        ...
        modelBuilder.Entity<Recipe>(entity =>
        {
            ...
            entity.Property(e => e.Id).ValueGeneratedNever().HasComment("Unique Id of this Recipe").HasColumnName("id");
            entity.Property(e => e.DataId).HasColumnName("data_Id");
            entity.Property(e => e.Difficulty).HasColumnName("difficulty");
            entity
                .Property(e => e.FailAmount)
            ...
            entity
                .Property(e => e.FailDestroySourceMessage)
                .HasColumnType("text")
            ...
            entity
                .Property(e => e.FailDestroyTargetMessage)
                .HasColumnType("text")
                .HasColumnName("fail_Destroy_Target_Message");
            entity.Property(e => e.FailMessage).HasColumnType("text").HasColumnName("fail_Message");
            entity
                .Property(e => e.FailWCID)
            ...
            entity
                .Property(e => e.SuccessDestroySourceMessage)
                .HasColumnType("text")
            ...
            entity
                .Property(e => e.SuccessDestroyTargetMessage)
                .HasColumnType("text")
                .HasColumnName("success_Destroy_Target_Message");
            entity.Property(e => e.SuccessMessage).HasColumnType("text").HasColumnName("success_Message");
            entity
                .Property(e => e.SuccessWCID)
        ...
        modelBuilder.Entity<RecipeMod>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Recipe Mod instance").HasColumnName("id");
            entity.Property(e => e.DataId).HasColumnName("data_Id");
        ...
        modelBuilder.Entity<RecipeModsBool>(entity =>
        {
            ...
            entity.Property(e => e.RecipeModId).HasComment("Unique Id of Recipe Mod").HasColumnName("recipe_Mod_Id");
            entity.Property(e => e.Source).HasColumnName("source");
            entity.Property(e => e.Stat).HasColumnName("stat");
            entity.Property(e => e.Value).HasColumnName("value");

            entity
                .HasOne(d => d.RecipeMod)
        ...
        modelBuilder.Entity<RecipeRequirementsBool>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Recipe Requirement instance").HasColumnName("id");
            entity.Property(e => e.Enum).HasColumnName("enum");
            entity.Property(e => e.Index).HasColumnName("index");
        ...
        modelBuilder.Entity<Spell>(entity =>
        {
            ...
            entity.Property(e => e.Id).ValueGeneratedNever().HasComment("Unique Id of this Spell").HasColumnName("id");
            ...
            entity.Property(e => e.Name).IsRequired().HasColumnType("text").HasColumnName("name");
        ...
        modelBuilder.Entity<TreasureDeath>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Treasure").HasColumnName("id");
            ...
            entity
                .Property(e => e.ItemTreasureTypeSelectionChances)
            ...
            entity
                .Property(e => e.MagicItemTreasureTypeSelectionChances)
        ...
        modelBuilder.Entity<TreasureGemCount>(entity =>
        {
            ...
            entity.ToTable("treasure_gem_count").HasCharSet("utf16").UseCollation("utf16_general_ci");
        ...
        modelBuilder.Entity<TreasureMaterialBase>(entity =>
        {
            ...
            entity.Property(e => e.MaterialId).HasComment("MaterialType").HasColumnName("material_Id");
            entity.Property(e => e.Probability).HasColumnName("probability");
            entity.Property(e => e.Tier).HasComment("Loot Tier").HasColumnName("tier");
        });
        ...
        modelBuilder.Entity<TreasureMaterialGroups>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.MaterialGroup).HasComment("MaterialType Group").HasColumnName("material_Group");
            entity.Property(e => e.MaterialId).HasComment("MaterialType").HasColumnName("material_Id");
            entity.Property(e => e.Probability).HasColumnName("probability");
            entity.Property(e => e.Tier).HasComment("Loot Tier").HasColumnName("tier");
        });
        ...
        modelBuilder.Entity<TreasureWielded>(entity =>
        {
            ...
            entity
                ...
                .HasColumnName("last_Modified");
            entity
                .Property(e => e.PaletteId)
                .HasComment("Palette Color of Object Generated")
                .HasColumnName("palette_Id");
            entity.Property(e => e.Probability).HasColumnName("probability");
            entity.Property(e => e.SetStart).HasColumnName("set_Start");
            entity.Property(e => e.Shade).HasComment("Shade of Object generated's Palette").HasColumnName("shade");
            entity
                .Property(e => e.StackSize)
                .HasDefaultValueSql("'1'")
            ...
            entity
                ...
                .HasComment("Type of Treasure for this instance")
                .HasColumnName("treasure_Type");
            entity.Property(e => e.Unknown1).HasComment("Always 0 in cache.bin").HasColumnName("unknown_1");
            entity.Property(e => e.Unknown10).HasComment("Always 0 in cache.bin").HasColumnName("unknown_10");
            entity.Property(e => e.Unknown11).HasComment("Always 0 in cache.bin").HasColumnName("unknown_11");
            entity.Property(e => e.Unknown12).HasComment("Always 0 in cache.bin").HasColumnName("unknown_12");
            entity.Property(e => e.Unknown3).HasComment("Always 0 in cache.bin").HasColumnName("unknown_3");
            entity.Property(e => e.Unknown4).HasComment("Always 0 in cache.bin").HasColumnName("unknown_4");
            entity.Property(e => e.Unknown5).HasComment("Always 0 in cache.bin").HasColumnName("unknown_5");
            entity.Property(e => e.Unknown9).HasComment("Always 0 in cache.bin").HasColumnName("unknown_9");
            entity
                .Property(e => e.WeenieClassId)
        ...
        modelBuilder.Entity<Version>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.BaseVersion).HasMaxLength(45).HasColumnName("base_Version");
            entity
                .Property(e => e.LastModified)
                .ValueGeneratedOnAddOrUpdate()
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime")
                .HasColumnName("last_Modified");
            entity.Property(e => e.PatchVersion).HasMaxLength(45).HasColumnName("patch_Version");
        });
        ...
        modelBuilder.Entity<Weenie>(entity =>
        {
            ...
            entity
                ...
                .HasColumnType("datetime")
                .HasColumnName("last_Modified");
            entity.Property(e => e.Type).HasComment("WeenieType").HasColumnName("type");
        });
        ...
        modelBuilder.Entity<WeeniePropertiesAnimPart>(entity =>
        {
            ...
            entity.ToTable(
                ...
                tb => tb.HasComment("Animation Part Changes (from PCAPs) of Weenies")
            );

            entity.HasIndex(e => new { e.ObjectId, e.Index }, "object_Id_index_uidx").IsUnique();

            entity.Property(e => e.Id).HasComment("Unique Id of this Property").HasColumnName("id");
        ...
        modelBuilder.Entity<WeeniePropertiesAttribute>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Property").HasColumnName("id");
            entity.Property(e => e.CPSpent).HasComment("XP spent on this attribute").HasColumnName("c_P_Spent");
            entity.Property(e => e.InitLevel).HasComment("innate points").HasColumnName("init_Level");
            entity.Property(e => e.LevelFromCP).HasComment("points raised").HasColumnName("level_From_C_P");
            entity
                .Property(e => e.ObjectId)
                .HasComment("Id of the object this property belongs to")
                .HasColumnName("object_Id");
        ...
        modelBuilder.Entity<WeeniePropertiesAttribute2nd>(entity =>
        {
            ...
            entity.ToTable(
                ...
                tb => tb.HasComment("Attribute2nd (Vital) Properties of Weenies")
            );
        ...
        modelBuilder.Entity<WeeniePropertiesBookPageData>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Property").HasColumnName("id");
            entity
                .Property(e => e.AuthorAccount)
                .IsRequired()
                .HasMaxLength(255)
                .HasDefaultValueSql("'prewritten'")
                .HasComment("Account Name of the Author of this page")
                .HasColumnName("author_Account");
            entity.Property(e => e.AuthorId).HasComment("Id of the Author of this page").HasColumnName("author_Id");
            entity
            ...
            entity
                ...
                .HasColumnName("object_Id");
            entity.Property(e => e.PageId).HasComment("Id of the page number for this page").HasColumnName("page_Id");
            entity
                .Property(e => e.PageText)
                .IsRequired()
        ...
        modelBuilder.Entity<WeeniePropertiesBool>(entity =>
        {
            ...
            entity
                ...
                .HasColumnName("type");
            entity.Property(e => e.Value).HasComment("Value of this Property").HasColumnName("value");
        ...
        modelBuilder.Entity<WeeniePropertiesCreateList>(entity =>
        {
            ...
            entity
                ...
                .HasComment("Id of the object this property belongs to")
                .HasColumnName("object_Id");
            entity.Property(e => e.Palette).HasComment("Palette Color of Object").HasColumnName("palette");
            entity.Property(e => e.Shade).HasComment("Shade of Object's Palette").HasColumnName("shade");
            entity
                .Property(e => e.StackSize)
                .HasDefaultValueSql("'1'")
                .HasComment("Stack Size of object to create (-1 = infinite)")
                .HasColumnName("stack_Size");
            entity.Property(e => e.TryToBond).HasComment("Unused?").HasColumnName("try_To_Bond");
            entity
                .Property(e => e.WeenieClassId)
        ...
        modelBuilder.Entity<WeeniePropertiesEmote>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Property").HasColumnName("id");
            entity.Property(e => e.Category).HasComment("EmoteCategory").HasColumnName("category");
            ...
            entity.Property(e => e.Quest).HasColumnType("text").HasColumnName("quest");
        ...
        modelBuilder.Entity<WeeniePropertiesEmoteAction>(entity =>
        {
            ...
            entity
                .Property(e => e.EmoteId)
                .HasComment("Id of the emote this property belongs to")
                .HasColumnName("emote_Id");
            entity.Property(e => e.Extent).HasDefaultValueSql("'1'").HasComment("?").HasColumnName("extent");
            ...
            entity.Property(e => e.ObjCellId).HasColumnName("obj_Cell_Id");
            entity.Property(e => e.Order).HasComment("Emote Action Sequence Order").HasColumnName("order");
            entity.Property(e => e.OriginX).HasColumnName("origin_X");
            entity.Property(e => e.OriginY).HasColumnName("origin_Y");
            entity.Property(e => e.OriginZ).HasColumnName("origin_Z");
            ...
            entity
                ...
                .HasColumnName("stack_Size");
            entity.Property(e => e.Stat).HasColumnName("stat");
            entity.Property(e => e.TestString).HasColumnType("text").HasColumnName("test_String");
            ...
            entity.Property(e => e.TryToBond).HasComment("Unused?").HasColumnName("try_To_Bond");
            entity.Property(e => e.Type).HasComment("EmoteType").HasColumnName("type");
        ...
        modelBuilder.Entity<WeeniePropertiesEventFilter>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Property").HasColumnName("id");
            entity.Property(e => e.Event).HasComment("Id of Event to filter").HasColumnName("event");
            entity
                .Property(e => e.ObjectId)
                .HasComment("Id of the object this property belongs to")
                .HasColumnName("object_Id");
        ...
        modelBuilder.Entity<WeeniePropertiesGenerator>(entity =>
        {
            ...
            entity.Property(e => e.AnglesY).HasColumnName("angles_Y");
            entity.Property(e => e.AnglesZ).HasColumnName("angles_Z");
            entity.Property(e => e.Delay).HasComment("Amount of delay before generation").HasColumnName("delay");
            entity
                .Property(e => e.InitCreate)
                .HasDefaultValueSql("'1'")
                .HasComment("Number of object to generate initially")
                .HasColumnName("init_Create");
            entity
                .Property(e => e.MaxCreate)
                .HasDefaultValueSql("'1'")
            ...
            entity
                ...
                .HasComment("Palette Color of Object Generated")
                .HasColumnName("palette_Id");
            entity.Property(e => e.Probability).HasDefaultValueSql("'1'").HasColumnName("probability");
            entity.Property(e => e.Shade).HasComment("Shade of Object generated's Palette").HasColumnName("shade");
            entity.Property(e => e.StackSize).HasComment("StackSize of object generated").HasColumnName("stack_Size");
            entity
                .Property(e => e.WeenieClassId)
                .HasComment("Weenie Class Id of object to generate")
                .HasColumnName("weenie_Class_Id");
            entity
                .Property(e => e.WhenCreate)
                .HasDefaultValueSql("'2'")
                .HasComment("When to generate the weenie object")
                .HasColumnName("when_Create");
            entity
                .Property(e => e.WhereCreate)
        ...
        modelBuilder.Entity<WeeniePropertiesPosition>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Position").HasColumnName("id");
            entity.Property(e => e.AnglesW).HasColumnName("angles_W");
            entity.Property(e => e.AnglesX).HasColumnName("angles_X");
            entity.Property(e => e.AnglesY).HasColumnName("angles_Y");
            entity.Property(e => e.AnglesZ).HasColumnName("angles_Z");
        ...
        modelBuilder.Entity<WeeniePropertiesSkill>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Unique Id of this Property").HasColumnName("id");
            entity
                .Property(e => e.InitLevel)
                .HasComment("starting point for advancement of the skill (eg bonus points)")
                .HasColumnName("init_Level");
            entity.Property(e => e.LastUsedTime).HasComment("time skill was last used").HasColumnName("last_Used_Time");
            entity.Property(e => e.LevelFromPP).HasComment("points raised").HasColumnName("level_From_P_P");
            entity
                .Property(e => e.ObjectId)
                .HasComment("Id of the object this property belongs to")
                .HasColumnName("object_Id");
            entity.Property(e => e.PP).HasComment("XP spent on this skill").HasColumnName("p_p");
            entity
                .Property(e => e.ResistanceAtLastCheck)
                .HasComment("last use difficulty")
                .HasColumnName("resistance_At_Last_Check");
            entity.Property(e => e.SAC).HasComment("skill state").HasColumnName("s_a_c");
            entity
                .Property(e => e.Type)
                .HasComment("Type of Property the value applies to (PropertySkill.????)")
                .HasColumnName("type");
        ...
        modelBuilder.Entity<WeeniePropertiesSpellBook>(entity =>
        {
            ...
            entity
                ...
                .HasColumnName("probability");
            entity.Property(e => e.Spell).HasComment("Id of Spell").HasColumnName("spell");
        ...
        modelBuilder.Entity<WeeniePropertiesTextureMap>(entity =>
        {
            ...
            entity.ToTable(
                ...
                tb => tb.HasComment("Texture Map Changes (from PCAPs) of Weenies")
            );
