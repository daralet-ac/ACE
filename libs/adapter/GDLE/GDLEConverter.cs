...
public static class GDLEConverter
{
                ...
                foreach (var link in lbi.LandblockInstanceLink)
                {
                    ...
                    if (WeenieNames != null && WeenieClassNames != null)
                    {
                        ...
                        if (instanceWcids.TryGetValue(link.ChildGuid, out var sourceWcid))
                        {
                            ...
                            _link.desc =
                                $"{sourceName}({sourceClassName})(wcid: {sourceWcid}) -> {targetClassName}(wcid: {lbi.WeenieClassId})";
                        }
                    }
    ...
    public static bool TryConvert(
        Models.Landblock input,
        out List<LandblockInstance> results,
        out List<LandblockInstanceLink> links
    )
    {
        try
        {
    ...
    private static void ReGuidAndConvertLandblocks(
    ...
    public static bool TryConvert(Recipe input, out Models.Recipe result)
    {
        try
        {
            ...
            foreach (var intReq in input.RecipeRequirementsInt)
            {
                ...
                requirements.IntRequirements.Add(
                    new Models.IntRequirement
                    {
                        Stat = intReq.Stat,
                        Value = intReq.Value,
            ...
            foreach (var floatReq in input.RecipeRequirementsFloat)
            {
                ...
                requirements.FloatRequirements.Add(
                    new Models.FloatRequirement
                    {
                        Stat = floatReq.Stat,
            ...
            foreach (var stringReq in input.RecipeRequirementsString)
            {
                ...
                requirements.StringRequirements.Add(
                    new Models.StringRequirement
                    {
                        Stat = stringReq.Stat,
            ...
            foreach (var boolReq in input.RecipeRequirementsBool)
            {
                ...
                requirements.BoolRequirements.Add(
                    new Models.BoolRequirement
                    {
                        Stat = boolReq.Stat,
                        Value = boolReq.Value,
        ...
        try
        {
            ...
            foreach (var value in input.Requirements)
            {
                ...
                if (value.IntRequirements != null)
                {
                    ...
                    {
                        result.RecipeRequirementsInt.Add(
                            new RecipeRequirementsInt
                            {
                                Index = index,
                ...
                if (value.DIDRequirements != null)
                {
                    ...
                    {
                        result.RecipeRequirementsDID.Add(
                            new RecipeRequirementsDID
                            {
                                Index = index,
                                Stat = requirement.Stat,
                                Value = requirement.Value,
                ...
                if (value.IIDRequirements != null)
                {
                    ...
                    {
                        result.RecipeRequirementsIID.Add(
                            new RecipeRequirementsIID
                            {
                                Index = index,
                                Stat = requirement.Stat,
                                Value = requirement.Value,
                ...
                if (value.FloatRequirements != null)
                {
                    ...
                    {
                        result.RecipeRequirementsFloat.Add(
                            new RecipeRequirementsFloat
                            {
                                Index = index,
                                Stat = requirement.Stat,
                                Value = requirement.Value,
                ...
                if (value.StringRequirements != null)
                {
                    ...
                    {
                        result.RecipeRequirementsString.Add(
                            new RecipeRequirementsString
                            {
                                Index = index,
                                Stat = requirement.Stat,
                                Value = requirement.Value,
                ...
                if (value.BoolRequirements != null)
                {
                    ...
                    {
                        result.RecipeRequirementsBool.Add(
                            new RecipeRequirementsBool
                            {
                                Index = index,
                                Stat = requirement.Stat,
                                Value = requirement.Value,
            ...
            for (var i = 0; i < 8; i++) // Must be 8
            {
                ...
                if (value.StringRequirements != null)
                {
                    ...
                    {
                        recipeMod.RecipeModsString.Add(
                            new RecipeModsString
                            {
                                Index = (sbyte)i,
                                Stat = mod.Stat,
                                Value = mod.Value,
                ...
                var add = (recipeMod.Health > 0 || recipeMod.Stamina > 0 || recipeMod.Mana > 0);
                add = (
                    add
                    || recipeMod.Unknown7
                    || recipeMod.DataId > 0
                    || recipeMod.Unknown9 > 0
                    || recipeMod.InstanceId > 0
                );
                add = (
                    add
                    || recipeMod.RecipeModsBool.Count > 0
                    || recipeMod.RecipeModsDID.Count > 0
                    || recipeMod.RecipeModsFloat.Count > 0
                    || recipeMod.RecipeModsIID.Count > 0
                    || recipeMod.RecipeModsInt.Count > 0
                    || recipeMod.RecipeModsString.Count > 0
                );
