...
namespace ACE.Server.Factories.Tables.Wcids
{
    ...
    {
        private static ChanceTable<WeenieClassName> BowWcids_All_T1_T5 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
        ...
        private static ChanceTable<WeenieClassName> BowWcids_All_T6_T8 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.bowshort,                     2.0f ),
            ( WeenieClassName.bowlong,                      2.0f ),
            ( WeenieClassName.nayin,                        2.0f ),
        ...
        private static ChanceTable<WeenieClassName> BowWcids_Aluvian_T1_T5 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.bowshort,                     1.0f ),
            ( WeenieClassName.bowlong,                      1.0f ),
        };

        private static ChanceTable<WeenieClassName> BowWcids_Aluvian_T6_T8 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
        ...
        private static ChanceTable<WeenieClassName> BowWcids_Gharundim_T1_T5 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.nayin,                        1.0f ),
            ( WeenieClassName.yag,                          1.0f ),
        };

        private static ChanceTable<WeenieClassName> BowWcids_Gharundim_T6_T8 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
        ...
        private static ChanceTable<WeenieClassName> BowWcids_Sho_T1_T5 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.yumi,                         1.0f ),
            ( WeenieClassName.shouyumi,                     1.0f ),
        };

        private static ChanceTable<WeenieClassName> BowWcids_Sho_T6_T8 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
