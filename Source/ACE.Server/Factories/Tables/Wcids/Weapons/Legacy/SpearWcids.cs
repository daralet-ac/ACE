...
namespace ACE.Server.Factories.Tables.Wcids
{
    public static class SpearWcids
    {
        ...
        private static ChanceTable<WeenieClassName> SpearWcids_All = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
        ...
        private static ChanceTable<WeenieClassName> SpearWcids_Aluvian_T1 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
        ...
        private static ChanceTable<WeenieClassName> SpearWcids_Aluvian = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.spear,              4.0f ),
            ( WeenieClassName.spearacid,          1.0f ),
            ( WeenieClassName.spearelectric,      1.0f ),
        ...
        private static ChanceTable<WeenieClassName> SpearWcids_Gharundim_T1 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
        ...
        private static ChanceTable<WeenieClassName> SpearWcids_Gharundim = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
             ( WeenieClassName.budiaq,            4.0f ),
            ( WeenieClassName.budiaqacid,         1.0f ),
            ( WeenieClassName.budiaqelectric,     1.0f ),
        ...
        private static ChanceTable<WeenieClassName> SpearWcids_Sho_T1 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
        ...
        private static ChanceTable<WeenieClassName> SpearWcids_Sho = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
             ( WeenieClassName.yari,              4.0f ),
            ( WeenieClassName.yariacid,           1.0f ),
            ( WeenieClassName.yarielectric,       1.0f ),
