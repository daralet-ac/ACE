...
namespace ACE.Server.Factories.Tables.Wcids
{
    public static class DaggerWcids
    {
        ...
        private static ChanceTable<WeenieClassName> DaggerWcids_All = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
        ...
        private static ChanceTable<WeenieClassName> DaggerWcids_Aluvian = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.knife,          4.0f ),
            ( WeenieClassName.knifeacid,      1.0f ),
            ( WeenieClassName.knifeelectric,  1.0f ),
        ...
        private static ChanceTable<WeenieClassName> DaggerWcids_Gharundim_T1 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
        ...
        private static ChanceTable<WeenieClassName> DaggerWcids_Gharundim = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.jambiya,          4.0f ),
            ( WeenieClassName.jambiyaacid,      1.0f ),
            ( WeenieClassName.jambiyaelectric,  1.0f ),
        ...
        private static ChanceTable<WeenieClassName> DaggerWcids_Sho_T1 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.knife,          1.0f ),
            ( WeenieClassName.dagger,         1.0f ),
            ( WeenieClassName.dirk,           1.0f ),
