...
namespace ACE.Server.Factories.Tables.Wcids
{
    public static class AxeWcids
    {
        ...
        private static ChanceTable<WeenieClassName> AxeWcids_Aluvian_T1 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
        ...
        private static ChanceTable<WeenieClassName> AxeWcids_Aluvian = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.axehand,           4.0f ),
            ( WeenieClassName.axehandacid,       1.0f ),
            ( WeenieClassName.axehandelectric,   1.0f ),
        ...
        private static ChanceTable<WeenieClassName> AxeWcids_Gharundim_T1 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
        ...
        private static ChanceTable<WeenieClassName> AxeWcids_Gharundim = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.tungi,             4.0f ),
            ( WeenieClassName.tungiacid,         1.0f ),
            ( WeenieClassName.tungielectric,     1.0f ),
        ...
        private static ChanceTable<WeenieClassName> AxeWcids_Sho_T1 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
