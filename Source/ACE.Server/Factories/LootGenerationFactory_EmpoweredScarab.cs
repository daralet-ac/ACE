    ...
    public static partial class LootGenerationFactory
    {
        ...
        private static void MutateEmpoweredanaScarab(WorldObject wo, TreasureDeath profile)
        {
            ...
            if (empoweredScarab.EmpoweredScarabEffectId == (int)EmpoweredScarabEffect.CastVuln)
            {
                ...
                empoweredScarab.Use = $"Whenever the wielder casts a Harm, Enfeeble, or Mana Drain spell, " +
            ...
            else if (empoweredScarab.EmpoweredScarabEffectId == (int)EmpoweredScarabEffect.CastVitalRate)
            {
                ...
                empoweredScarab.Use = "Whenever the wielder casts a Heal or Harm spell, there is a chance the target will also be affected by Regeneration or Fester, respectively.\n\n" +
            ...
            else if (empoweredScarab.EmpoweredScarabEffectId == (int)EmpoweredScarabEffect.CastItemBuff)
            {
                ...
                empoweredScarab.Use = "Whenever the wielder casts a Heal spell, there is a chance the target will also be affected by Defender Other.\n\n" +
            ...
            else if (empoweredScarab.EmpoweredScarabEffectId == (int)EmpoweredScarabEffect.Intensity)
            {
                ...
                empoweredScarab.Use = $"Whenever the wielder casts any spell, there is a chance the spell will " +
            ...
            else if (empoweredScarab.EmpoweredScarabEffectId == (int)EmpoweredScarabEffect.Shield)
            {
                ...
                empoweredScarab.Use = $"Whenever the wielder casts any spell, there is a chance they will " +
            ...
            else if (empoweredScarab.EmpoweredScarabEffectId == (int)EmpoweredScarabEffect.ManaReduction)
            {
                ...
                empoweredScarab.Use = $"Whenever the wielder casts any spell, there is a chance that the cost of the spell will be reduced.\n\n" +
                    "Only affects spells that are less than or equal to the Max level value.";
            }
            ...
            else if (empoweredScarab.EmpoweredScarabEffectId == (int)EmpoweredScarabEffect.Duplicate)
            {
                ...
                empoweredScarab.Use = $"Whenever the wielder casts a War spell, there is a chance that the spell will be duplicated and cast against the same target.\n\n" +
                    "Only affects spells that are less than or equal to the Max level value.";
            }
            ...
            else if (empoweredScarab.EmpoweredScarabEffectId == (int)EmpoweredScarabEffect.Detonate)
            {
                ...
                empoweredScarab.Use = $"Whenever the wielder damages a creature with a War spell, there is a chance that the spell will detonate on impact, causing an explosion of the same element.\n\n" +
                    "Only affects spells that are less than or equal to the Max level value.";
            }
            ...
            else if (empoweredScarab.EmpoweredScarabEffectId == (int)EmpoweredScarabEffect.Crit)
            {
                ...
                empoweredScarab.Use = $"Whenever the wielder performs a critical strike with a War spell, they gain an offensive buff, increasing critical damage rating by 50 for 12 seconds.\n\n" +
                    "Only affects spells that are less than or equal to the Max level value.";
            }
        }
