...
public class SphereTests
{
    ...
    public void Sphere_IntersectsSphere()
    {
        ...
        transition.SpherePath.GlobalCurrCenter.AddRange(
            new List<Sphere>() { new Sphere(Vector3.Zero, 0), new Sphere(Vector3.Zero, 0) }
        );
    ...
    public void Sphere_IntersectsSphere_Inner(
        Sphere sphere,
        Transition transition,
        Sphere sphereCollide,
        Sphere sphereNonCollide,
        bool firstTest = true,
