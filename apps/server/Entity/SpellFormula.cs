...
public class SpellFormula
{
    ...
    /// </summary>
    public static SpellTable SpellTable
    {
        get => DatManager.PortalDat.SpellTable;
    }

    /// <summary>
    /// The spell components table from the portal.dat
    /// </summary>
    public static SpellComponentsTable SpellComponentsTable
    {
        get => DatManager.PortalDat.SpellComponentsTable;
    }
    ...
    public List<MotionCommand> WindupGestures
    {
        get
        {
            ...
            foreach (var scarab in Scarabs)
            {
                ...
                {
                    Console.WriteLine(
                        $"SpellFormula.WindupGestures error: spell ID {Spell.Id} contains scarab {scarab} not found in components table, skipping"
                    );
                    continue;
                }
