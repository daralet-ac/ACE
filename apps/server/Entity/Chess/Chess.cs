...
public class Chess
{
    ...
    public static readonly List<int> PieceWorth = new List<int> { 0, 10, 50, 30, 30, 90, 900 };
    ...
    public static readonly Dictionary<ChessColor, List<RookCastleFlag>> RookFlags = new Dictionary<
        ChessColor,
        List<RookCastleFlag>
    >()
    {
        {
            ChessColor.White,
            new List<RookCastleFlag>()
            {
                new RookCastleFlag(new Vector2(0, 0), ChessMoveFlag.QueenSideCastle),
                new RookCastleFlag(new Vector2(7, 0), ChessMoveFlag.KingSideCastle)
            }
        },
        {
            ChessColor.Black,
            new List<RookCastleFlag>()
            {
                new RookCastleFlag(new Vector2(0, 7), ChessMoveFlag.QueenSideCastle),
                new RookCastleFlag(new Vector2(7, 7), ChessMoveFlag.KingSideCastle)
            }
        }
    };
    ...
    public static readonly Dictionary<ChessPieceType, List<Vector2>> PieceOffsets = new Dictionary<
        ChessPieceType,
        List<Vector2>
    >()
    {
        ...
        },
        {
            ...
            new List<Vector2>() { new Vector2(1, 1), new Vector2(1, -1), new Vector2(-1, -1), new Vector2(-1, 1) }
        },
        {
