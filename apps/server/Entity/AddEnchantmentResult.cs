...
public class AddEnchantmentResult
{
    ...
    public void BuildStack(
        List<PropertiesEnchantmentRegistry> entries,
        Spell spell,
        WorldObject caster,
        bool equip = false,
        ...
        foreach (var entry in entries.OrderByDescending(i => i.PowerLevel))
        {
            ...
            else if (powerLevel == entry.PowerLevel)
            {
                ...
                else
                {
                    ...
                    if (
                        spellDuration > entryDuration
                        || spellDuration == entryDuration && !SpellSet.SetSpells.Contains(entry.SpellId)
                    )
                    {
                        Surpass.Add(entry);
                    }
    ...
    private SpellId[] StackableSpellEnchantments =
    {
