...
public class ItemsToReceive
{
    ...
    public bool PlayerExceedsLimits =>
        PlayerOutOfInventorySlots || PlayerOutOfContainerSlots || PlayerExceedsAvailableBurden;
    ...
    {
        var requiredSlots = GetItemSlotAndBurdenRequirements(
            weenieClassId,
            amount,
            out var requiredEncumbrance,
            out var itemRequiresBackpackSlot
        );
    ...
    /// </summary>
    private int GetItemSlotAndBurdenRequirements(
        uint weenieClassId,
        int amount,
        out int requiredEncumbrance,
        out bool requiresBackpackSlot
    )
    {
