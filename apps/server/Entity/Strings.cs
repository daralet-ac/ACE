...
public class Strings
{
    ...
    {
        new DeathMessage("You split {0} apart!", "{1} splits you apart!", "{1} splits {0} apart!"),
        new DeathMessage("You cleave {0} in twain!", "{1} cleaves you in twain!", "{1} cleaves {0} in twain!"),
        new DeathMessage(
    ...
    {
        new DeathMessage("You run {0} through!", "{1} runs you through!", "{1} runs {0} through!"),
        new DeathMessage(
    ...
    {
        new DeathMessage("Your attack stops {0} cold!", "{1}'s attack stops you cold!", "{1}'s attack stops {0} cold!"),
        new DeathMessage(
    ...
    {
        new DeathMessage("You obliterate {0}!", "{1} obliterates you!", "{1} obliterates {0}!"),
        new DeathMessage("You smite {0} mightily!", "{1} smites you mightily!", "{1} smites {0} mightily!"),
        new DeathMessage(
    ...
    {
        new DeathMessage("You killed {0}!", "You were killed by {1}!", "{0} was killed by {1}!"),
        new DeathMessage("{0} died!", "You died!", "{0} died!")
    };
