...
public class ActionChain
{
    ...
    {
        var newElm = new ChainElement(actor, new ActionEventDelegate(action));
        AddAction(newElm);
    ...
    {
        var newElm = new ChainElement(actor, action);
        AddAction(newElm);
    ...
    public ActionChain AddBranch(
        IActor conditionActor,
        Func<bool> condition,
        ChainElement trueBranch,
        ChainElement falseBranch
    )
    {
    ...
    public ActionChain AddBranch(
        IActor conditionActor,
        Func<bool> condition,
        ActionChain trueBranch,
        ActionChain falseBranch
    )
    {
