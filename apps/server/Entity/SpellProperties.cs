...
partial class Spell
{
    ...
    {
        get => (SpellFlags)_spellBase.Bitfield;
    }
    ...
    {
        get => _spellBase.BaseRangeConstant;
    }
    ...
    /// </summary>
    public uint PowerMod
    {
        get => Math.Max(Power, 25);
    }
    ...
    {
        get => _spellBase.SpellEconomyMod;
    }
    ...
    {
        get => _spellBase.DegradeModifier;
    }
    ...
    {
        get => _spellBase.PortalLifetime;
    }

    /// <summary>
    /// uint values correspond to the SpellComponentsTable
    /// </summary>
    private List<uint> _formula
    {
        get => _spellBase.Formula;
    }
    ...
    {
        get => (PlayScript)_spellBase.CasterEffect;
    }
    ...
    {
        get => (PlayScript)_spellBase.TargetEffect;
    }
    ...
    {
        get => (PlayScript)_spellBase.FizzleEffect;
    }
    ...
    {
        get => _spellBase.RecoveryInterval;
    }
    ...
    {
        get => (ItemType)_spellBase.NonComponentTargetType;
    }
    ...
    {
        get => (EnchantmentTypeFlags)(_spell.StatModType ?? 0);
    }
    ...
    {
        get => _spell.StatModKey ?? 0;
    }

    /// <summary>
    /// The amount to modify a stat
    /// </summary>
    public float BaseStatModVal
    {
        get => _spell.StatModVal ?? 0.0f;
    }

    public float StatModVal
    {
        get => (float)(BaseStatModVal * SpellStatModVal);
    }
    ...
    {
        get => _spell.BaseIntensity ?? 0;
    }

    public int MinDamage
    {
        get => (int)(BaseIntensity * SpellPowerMod);
    }
    ...
    {
        get => _spell.NumProjectilesVariance ?? 0;
    }
    ...
    {
        get => _spell.DefaultLaunchAngle ?? 0;
    }
    ...
    public Vector3 CreateOffset
    {
        get =>
            new Vector3(
                _spell.CreateOffsetOriginX ?? 0.0f,
                _spell.CreateOffsetOriginY ?? 0.0f,
                _spell.CreateOffsetOriginZ ?? 0.0f
            );
    }
    ...
    {
        get => new Vector3(_spell.PaddingOriginX ?? 0.0f, _spell.PaddingOriginY ?? 0.0f, _spell.PaddingOriginZ ?? 0.0f);
    }
    ...
    public Vector3 Dims
    {
        get => new Vector3(_spell.DimsOriginX ?? 0.0f, _spell.DimsOriginY ?? 0.0f, _spell.DimsOriginZ ?? 0.0f);
    }

    /// <summary>
    /// The maximum variation for spawn position
    /// </summary>
    public Vector3 Peturbation
    {
        get =>
            new Vector3(
                _spell.PeturbationOriginX ?? 0.0f,
                _spell.PeturbationOriginY ?? 0.0f,
                _spell.PeturbationOriginZ ?? 0.0f
            );
    }
    ...
    {
        get => (CreatureType)(_spell.SlayerCreatureType ?? 0);
    }
    ...
    {
        get => _spell.SlayerDamageBonus ?? 0;
    } // 0 = additive, or 1 = multiplier?
    ...
    {
        get => _spell.CritMultiplier ?? 1.0;
    } // verify default multiplier?
    ...
    {
        get => Convert.ToBoolean(_spell.IgnoreMagicResist ?? 0);
    } // verify bool?
    ...
    {
        get => _spell.ElementalModifier ?? 1.0;
    } // verify default multiplier?
    ...
    {
        get => _spell.DrainPercentage ?? 0.0f;
    }
    ...
    {
        get => (_spell.DamageRatio ?? 1.0f) * SpellPowerMod;
    }
    ...
    {
        get => (DamageType)(_spell.DamageType ?? 0);
    }
    ...
    public int Boost
    {
        get => (int)((_spell.Boost ?? 0) * SpellPowerMod);
    }
    ...
    {
        get => _spell.BoostVariance ?? 0;
    }

    public int MaxBoost
    {
        get => (int)((_spell.Boost ?? 0) * SpellPowerMod) + BoostVariance;
    }

    /// <summary>
    /// The source vital for a life spell
    /// </summary>
    public PropertyAttribute2nd Source
    {
        get => (PropertyAttribute2nd)(_spell.Source ?? 0);
    }

    /// <summary>
    /// The destination vital for a life spell
    /// </summary>
    public PropertyAttribute2nd Destination
    {
        get => (PropertyAttribute2nd)(_spell.Destination ?? 0);
    }
    ...
    {
        get => (_spell.Proportion ?? 1.0f) * SpellPowerMod;
    }
    ...
    {
        get => (int)((_spell.TransferCap ?? 0) * SpellPowerMod);
    }
    ...
    {
        get => (TransferFlags)(_spell.TransferBitfield ?? 0);
    }
    ...
    public Position Position
    {
        get =>
            new Position(
                _spell.PositionObjCellId ?? 0,
                new Vector3(
                    _spell.PositionOriginX ?? 0.0f,
                    _spell.PositionOriginY ?? 0.0f,
                    _spell.PositionOriginZ ?? 0.0f
                ),
                new Quaternion(
                    _spell.PositionAnglesX ?? 0.0f,
                    _spell.PositionAnglesY ?? 0.0f,
                    _spell.PositionAnglesZ ?? 0.0f,
                    _spell.PositionAnglesW ?? 0.0f
                )
            );
    }
    ...
    {
        get => (MagicSchool)(_spell.DispelSchool ?? 0);
    }
