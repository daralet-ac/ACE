...
public class Enlightenment
{
    ...
    public static bool VerifyRequirements(Player player)
    {
        if (player.Level < 275)
        {
            player.Session.Network.EnqueueSend(
                new GameMessageSystemChat($"You must be level 275 for enlightenment.", ChatMessageType.Broadcast)
            );
            return false;
        }
        ...
        if (!VerifyLumAugs(player))
        {
            player.Session.Network.EnqueueSend(
                new GameMessageSystemChat(
                    $"You must have all luminance auras for enlightenment.",
    ...
    public static void RemoveSociety(Player player)
    {
        ...
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.Faction1Bits, 0)
        );
        player.SocietyRankCelhan = null;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.SocietyRankCelhan, 0)
        );
        player.SocietyRankEldweb = null;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.SocietyRankEldweb, 0)
        );
        player.SocietyRankRadblo = null;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.SocietyRankRadblo, 0)
        );
    }
    ...
    public static void RemoveLevel(Player player)
    {
        ...
        player.Level = 1;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.Level, player.Level ?? 0)
        );
    }
    ...
    public static void RemoveAetheria(Player player)
    {
        ...
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.AetheriaBitfield, 0)
        );
    ...
    public static void RemoveAttributes(Player player)
    {
        ...
        for (var i = 1; i < propertyCount; i++)
        {
            ...
            player.Session.Network.EnqueueSend(
                new GameMessagePrivateUpdateAttribute(player, player.Attributes[attribute])
            );
        }
    ...
    public static void RemoveSkills(Player player)
    {
        ...
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt64(player, PropertyInt64.AvailableExperience, 0)
        );
    ...
    public static void RemoveLuminance(Player player)
    {
        ...
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugDamageRating, 0)
        );
        player.LumAugDamageReductionRating = 0;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugDamageReductionRating, 0)
        );
        player.LumAugCritDamageRating = 0;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugCritDamageRating, 0)
        );
        player.LumAugCritReductionRating = 0;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugCritReductionRating, 0)
        );
        //player.LumAugSurgeEffectRating = 0;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugSurgeEffectRating, 0)
        );
        player.LumAugSurgeChanceRating = 0;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugSurgeChanceRating, 0)
        );
        player.LumAugItemManaUsage = 0;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugItemManaUsage, 0)
        );
        player.LumAugItemManaGain = 0;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugItemManaGain, 0)
        );
        player.LumAugVitality = 0;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugVitality, 0)
        );
        player.LumAugHealingRating = 0;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugHealingRating, 0)
        );
        player.LumAugSkilledCraft = 0;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugSkilledCraft, 0)
        );
        player.LumAugSkilledSpec = 0;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugSkilledSpec, 0)
        );
        player.LumAugAllSkills = 0;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.LumAugAllSkills, 0)
        );

        player.AvailableLuminance = null;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt64(player, PropertyInt64.AvailableLuminance, 0)
        );
        player.MaximumLuminance = null;
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt64(player, PropertyInt64.MaximumLuminance, 0)
        );
    ...
    public static void AddPerks(WorldObject npc, Player player)
    {
        ...
        player.Session.Network.EnqueueSend(
            new GameMessagePrivateUpdatePropertyInt(player, PropertyInt.Enlightenment, player.Enlightenment)
        );
        ...
        PlayerManager.BroadcastToAll(new GameMessageSystemChat(msg, ChatMessageType.WorldBroadcast), msg, "World");
