...
public class LandblockMesh : Mesh
{
    ...
    public float[,] GetVertexHeights()
    {
        ...
        for (var x = 0; x < VertexDim; x++)
        {
            for (var y = 0; y < VertexDim; y++)
            {
    ...
    public void BuildTriangles()
    {
        ...
        for (var x = 0; x < CellDim; x++)
        {
            ...
            {
                var lowerLeft = x + y * VertexDim;
                var lowerRight = (x + 1) + y * VertexDim;
                var topLeft = x + (y + 1) * VertexDim;
                var topRight = (x + 1) + (y + 1) * VertexDim;
