...
public static partial class ServerBuildInfo
{
    ...
    public static DateTime CompilationTimestampUtc =>
        new DateTime(BuildYear, BuildMonth, BuildDay, BuildHour, BuildMinute, BuildSecond, DateTimeKind.Utc);
    ...
    public static string GetVersionInfo()
    {
        ...
        var msg =
            $"Server binaries version {FullVersion} - compiled {CompilationTimestampUtc:ddd MMM d HH:mm:ss yyyy} : ACEmulator\n";

        msg +=
            $"Server database version Base: {databaseVersion.BaseVersion} Patch: {databaseVersion.PatchVersion} - compiled {databaseVersion.LastModified:ddd MMM d HH:mm:ss yyyy}\n";
