...
{
    private static ChanceTable<int> T1_T3_PetLevelChances = new ChanceTable<int>() { (50, 1.0f) };

    private static ChanceTable<int> T4_PetLevelChances = new ChanceTable<int>() { (50, 0.75f), (80, 0.25f) };
