...
{
    private static ChanceTable<int> T1_ItemMaxLevel = new ChanceTable<int>() { (1, 1.0f) };

    private static ChanceTable<int> T2_ItemMaxLevel = new ChanceTable<int>() { (1, 0.99f), (2, 0.01f), };

    private static ChanceTable<int> T3_T4_ItemMaxLevel = new ChanceTable<int>() { (1, 0.44f), (2, 0.55f), (3, 0.01f), };
