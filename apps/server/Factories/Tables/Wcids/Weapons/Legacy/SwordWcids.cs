...
{
    private static ChanceTable<WeenieClassName> SwordWcids_All = new ChanceTable<WeenieClassName>(
    ...
    private static ChanceTable<WeenieClassName> SwordWcids_Aluvian_T1 = new ChanceTable<WeenieClassName>(
        ChanceTableType.Weight
    )
    {
    ...
    private static ChanceTable<WeenieClassName> SwordWcids_Aluvian = new ChanceTable<WeenieClassName>(
        ChanceTableType.Weight
    )
    {
        (WeenieClassName.swordshort, 4.0f),
    ...
    private static ChanceTable<WeenieClassName> SwordWcids_Gharundim_T1 = new ChanceTable<WeenieClassName>(
        ChanceTableType.Weight
    )
    {
    ...
    private static ChanceTable<WeenieClassName> SwordWcids_Gharundim = new ChanceTable<WeenieClassName>(
        ChanceTableType.Weight
    )
    {
    ...
    private static ChanceTable<WeenieClassName> SwordWcids_Sho_T1 = new ChanceTable<WeenieClassName>(
        ChanceTableType.Weight
    )
    {
    ...
    private static ChanceTable<WeenieClassName> SwordWcids_Sho = new ChanceTable<WeenieClassName>(
        ChanceTableType.Weight
    )
    {
