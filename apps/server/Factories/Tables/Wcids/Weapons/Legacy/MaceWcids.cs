...
namespace ACE.Server.Factories.Tables.Wcids
{
    public static class MaceWcids
    {
        ...
        private static ChanceTable<WeenieClassName> MaceWcids_Aluvian_T1 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
        ...
        private static ChanceTable<WeenieClassName> MaceWcids_Aluvian = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.club,                4.0f ),
            ( WeenieClassName.clubacid,            1.0f ),
            ( WeenieClassName.clubelectric,        1.0f ),
        ...
        private static ChanceTable<WeenieClassName> MaceWcids_Gharundim_T1 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.clubspiked,       3.0f ),
        ...
        private static ChanceTable<WeenieClassName> MaceWcids_Gharundim = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.kasrullah,           4.0f ),
            ( WeenieClassName.kasrullahacid,       1.0f ),
            ( WeenieClassName.kasrullahelectric,   1.0f ),
        ...
        private static ChanceTable<WeenieClassName> MaceWcids_Sho_T1 = new ChanceTable<WeenieClassName>(ChanceTableType.Weight)
        {
            ( WeenieClassName.clubspiked,       3.0f ),
