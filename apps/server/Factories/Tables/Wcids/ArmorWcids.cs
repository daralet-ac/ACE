...
public static class ArmorWcids
{
    ...
    private static ChanceTable<WeenieClassName> ClothAluvianWcids = new ChanceTable<WeenieClassName>(
        ChanceTableType.Weight
    )
    {
    ...
    private static ChanceTable<WeenieClassName> ClothGharuWcids = new ChanceTable<WeenieClassName>(
        ChanceTableType.Weight
    )
    {
    ...
    private static readonly Dictionary<WeenieClassName, TreasureArmorType> _combined =
        new Dictionary<WeenieClassName, TreasureArmorType>();
