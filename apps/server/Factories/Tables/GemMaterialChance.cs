...
public static class GemMaterialChance
{
    ...
    private static ChanceTable<GemResult> class_materialChance = new ChanceTable<GemResult>(ChanceTableType.Weight)
    {
        ...
        (new GemResult(WeenieClassName.gemaquamarine, MaterialType.Aquamarine), 1.0f),
        (new GemResult(WeenieClassName.gemazurite, MaterialType.Azurite), 1.0f),
        (new GemResult(WeenieClassName.gemblackgarnet, MaterialType.BlackGarnet), 1.0f),
        (new GemResult(WeenieClassName.gemblackopal, MaterialType.BlackOpal), 1.0f),
        ...
        (new GemResult(WeenieClassName.jewelemerald, MaterialType.Emerald), 1.0f),
        (new GemResult(WeenieClassName.gemfireopal, MaterialType.FireOpal), 1.0f),
        ...
        (new GemResult(WeenieClassName.gemimperialtopaz, MaterialType.ImperialTopaz), 1.0f),
        (new GemResult(WeenieClassName.gemjet, MaterialType.Jet), 1.0f),
        ...
        (new GemResult(WeenieClassName.gemmoonstone, MaterialType.Moonstone), 1.0f),
        ...
        (new GemResult(WeenieClassName.gemredgarnet, MaterialType.RedGarnet), 1.0f),
        ...
        (new GemResult(WeenieClassName.gemsunstone, MaterialType.Sunstone), 1.0f),
        (new GemResult(WeenieClassName.gemtigereye, MaterialType.TigerEye), 1.0f),
        (new GemResult(WeenieClassName.gemtourmaline, MaterialType.Tourmaline), 1.0f),
        ...
        (new GemResult(WeenieClassName.gemwhitesapphire, MaterialType.WhiteSapphire), 1.0f),
    ...
    {
        gemClass = Math.Clamp(gemClass, 1, 1);
    ...
    /// </summary>
    private static readonly List<int> gemClassValue = new List<int>() { 100 };
