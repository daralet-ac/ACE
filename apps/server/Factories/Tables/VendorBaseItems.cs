...
{
    private const int HeritageAny = 0,
        HeritageAluvian = 1,
        HeritageGharundim = 2,
        HeritageSho = 3;

    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> ArchmageItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> ArmorerItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> BarkeeperItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> BlacksmithItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> BowyerItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> ButcherItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> GrocerItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> HealerItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> IvoryTraderItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> JewelerItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> LeatherTraderItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> ProvisionerItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> ScribeItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> ShopkeeperItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> TailorItems = new List<(
        int,
        bool,
        int,
        uint,
    ...
    // <(tier, onlyThisTier, heritage, wcid, paletteTemplate, shade, stackSize)>
    public static readonly List<(int, bool, int, uint, int, double, int)> WeaponsmithItems = new List<(
        int,
        bool,
        int,
        uint,
