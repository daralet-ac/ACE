...
{
    private static ChanceTable<int> T1_NumCantrips = new ChanceTable<int>() { (0, 0.95f), (1, 0.05f), };

    private static ChanceTable<int> T2_NumCantrips = new ChanceTable<int>() { (0, 0.90f), (1, 0.10f), };

    private static ChanceTable<int> T3_NumCantrips = new ChanceTable<int>() { (0, 0.725f), (1, 0.250f), (2, 0.025f), };
    ...
    private static ChanceTable<int> T1_T2_CantripLevel = new ChanceTable<int>() { (1, 1.0f) };

    private static ChanceTable<int> T3_CantripLevel = new ChanceTable<int>() { (1, 0.97f), (2, 0.03f), };

    private static ChanceTable<int> T4_CantripLevel = new ChanceTable<int>() { (1, 0.90f), (2, 0.10f), };

    private static ChanceTable<int> T5_CantripLevel = new ChanceTable<int>() { (1, 0.85f), (2, 0.15f), };

    private static ChanceTable<int> T6_CantripLevel = new ChanceTable<int>() { (1, 0.80f), (2, 0.20f), };

    private static ChanceTable<int> T7_CantripLevel = new ChanceTable<int>() { (1, 0.15f), (2, 0.60f), (3, 0.25f) };
