...
{
    private static readonly Dictionary<SpellId, List<SpellId>> spellProgression =
        new Dictionary<SpellId, List<SpellId>>();
    ...
    public static readonly List<SpellId> PortalTie = new List<SpellId>() { SpellId.PortalTie1, SpellId.PortalTie2, };
    ...
    public static readonly List<SpellId> MacersBoon = new List<SpellId>() { SpellId.MacersBoon, SpellId.MacersBoon3, };
    ...
    public static readonly List<SpellId> SetHealth = new List<SpellId>() { SpellId.SetHealth2, SpellId.SetHealth3, };

    public static readonly List<SpellId> SetMana = new List<SpellId>() { SpellId.SetMana2, SpellId.SetMana3, };

    public static readonly List<SpellId> SetStamina = new List<SpellId>() { SpellId.SetStamina2, SpellId.SetStamina3, };
    ...
    public static readonly List<SpellId> AcidSpit = new List<SpellId>() { SpellId.AcidSpit1, SpellId.AcidSpit2, };
    ...
    )
    {
        ...
        var spellLevelIndex = Math.Max(level - 1, 0);

        while (
            ifNoMatchReturnLowestPossibleLevel
            && spellLevelIndex < spellLevels.Count
            && spellLevels[spellLevelIndex] == SpellId.Undef
        )
        {
