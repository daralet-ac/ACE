...
public static class ArmorModVsTypeChance
{
    ...
    private static ChanceTable<int> ArmorModVsType_T2_QualityLevel = new ChanceTable<int>() { (1, 1.0f) };

    private static ChanceTable<int> ArmorModVsType_T3_QualityLevel = new ChanceTable<int>() { (1, 0.5f), (2, 0.5f), };
