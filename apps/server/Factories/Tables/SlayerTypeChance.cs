...
public static class SlayerTypeChance
{
    ...
    private static ChanceTable<CreatureType> T1_SlayerTypeChances = new ChanceTable<CreatureType>(
    ...
    private static ChanceTable<CreatureType> T2_SlayerTypeChances = new ChanceTable<CreatureType>(
        ChanceTableType.Weight
    )
    {
        (CreatureType.Drudge, 1.0f),
    ...
    private static ChanceTable<CreatureType> T3_SlayerTypeChances = new ChanceTable<CreatureType>(
        ChanceTableType.Weight
    )
    {
        (CreatureType.Drudge, 1.0f),
    ...
    private static ChanceTable<CreatureType> T4_SlayerTypeChances = new ChanceTable<CreatureType>(
        ChanceTableType.Weight
    )
    {
        (CreatureType.Drudge, 1.0f),
    ...
    private static ChanceTable<CreatureType> T5_SlayerTypeChances = new ChanceTable<CreatureType>(
        ChanceTableType.Weight
    )
    {
        (CreatureType.Drudge, 1.0f),
    ...
    private static ChanceTable<CreatureType> T6_T8_SlayerTypeChances = new ChanceTable<CreatureType>(
        ChanceTableType.Weight
    )
    {
        (CreatureType.Drudge, 1.0f),
