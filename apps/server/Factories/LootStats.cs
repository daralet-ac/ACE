            ...
            switch (testItem.ItemType)
            {
                ...
                case ItemType.MeleeWeapon:
                    ...
                    if (testItem.IsTwoHanded)
                    {
                        ...
                        {
                            MeleeWeapons.Add(
                                $"{testItem.WeaponSkill},{wield},{testItem.Damage.Value},{strikeType},{testItem.DamageVariance.Value},{testItem.WeaponPhysicalDefense.Value},{magicDefMod},{missileDefMod},{cantrip},{value},{testItem.EncumbranceVal},{testItem.Name}"
                            );
                        }
                        else
                        {
                ...
                case ItemType.Armor:
                    ...
                    {
                        Armor.Add(
                            $"{testItem.ArmorLevel},{testItem.ItemDifficulty},{testItem.Value.Value},{testItem.EncumbranceVal},{testItem.EpicCantrips.Count},{testItem.LegendaryCantrips.Count},{equipmentSet},{testItem.Name}"
                        );
                    }
                    else
                    {
                ...
                case ItemType.Clothing:
                    if (testItem.Name.Contains("Cloak"))
                    {
                        ...
                        {
                            Cloaks.Add(
                                $"{testItem.ItemMaxLevel},{testItem.WieldDifficulty},{testItem.CloakWeaveProc.Value},{testItem.Value.Value},{cloakSet}"
                            );
                        }
                        else
                        {
                ...
                case ItemType.Misc:
                    ...
                    var potionE = "Potion";
                    var potionF = "Draught";
                    var potionG = "Tincture";

                    var healingKits = "Kit";
                    var spellcompGlyph = "Glyph";
                    var spellcompInk = "Ink";
                    var spellcompQuill = "Quill";
                    ...
                    else if (testItem is PetDevice petDevice)
                    {
                        ...
                        {
                            Pets.Add(
                                $"{petLevel},{damage},{damageResist},{crit},{critDamage},{critDamageResist},{critResist},{totalRatings}"
                            );
                        }
                        else
                        {
                        ...
                        testItem.Name.Contains(potionA)
                        || testItem.Name.Contains(potionB)
                        || testItem.Name.Contains(potionC)
                        || testItem.Name.Contains(potionD)
                        || testItem.Name.Contains(potionE)
                        || testItem.Name.Contains(potionF)
                        || testItem.Name.Contains(potionG)
                    )
                    {
                        Potions++;
                    }
                    else if (
                        testItem.Name.Contains(spellcompGlyph)
                        || testItem.Name.Contains(spellcompInk)
                        || testItem.Name.Contains(spellcompQuill)
                    )
                    {
                        LevelEightComp++;
                    }
                ...
                case ItemType.MissileWeapon:
                    ...
                    else
                    {
                        ...
                        {
                            MissileWeapons.Add(
                                $"{missileType},{wield},{damageMod},{eleBonus},{testItem.WeaponPhysicalDefense.Value},{magicDefMod},{missileDefMod},{value},{testItem.EncumbranceVal}"
                            );
                        }
                        else
                        {
                ...
                case ItemType.Caster:
                    ...
                    {
                        CasterWeapons.Add(
                            $"{wield},{testItem.Name},{eleMod},{testItem.WeaponPhysicalDefense.Value},{magicDefMod},{missileDefMod},{value},{testItem.EncumbranceVal},{ItemMaxMana}"
                        );
                    }
                    else
                    {
