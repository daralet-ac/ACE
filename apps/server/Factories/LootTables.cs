...
public static class LootTables
{
    ...
    public static readonly int[][] DefaultMaterial =
    {
        ...
        new int[]
        {
            (int)MaterialType.Oak,
            (int)MaterialType.Teak,
            (int)MaterialType.Mahogany,
            (int)MaterialType.Pine,
            (int)MaterialType.Ebony
        },
        // Metal
        new int[]
        {
            (int)MaterialType.Iron,
            (int)MaterialType.Steel,
            (int)MaterialType.Copper,
            (int)MaterialType.Bronze,
            (int)MaterialType.Brass,
            (int)MaterialType.Pyreal,
        },
        // Common Gems
        new int[]
        {
            (int)MaterialType.Amethyst,
            (int)MaterialType.GreenGarnet,
            (int)MaterialType.LavenderJade,
            (int)MaterialType.Malachite,
            (int)MaterialType.Opal,
            (int)MaterialType.RoseQuartz
        },
        // Stone
        new int[]
        {
            (int)MaterialType.Granite,
            (int)MaterialType.Ceramic,
            (int)MaterialType.Porcelain,
            (int)MaterialType.Alabaster,
            (int)MaterialType.Marble,
            (int)MaterialType.Sandstone,
            (int)MaterialType.Ivory
        },
        // Cloth
        new int[]
        {
            (int)MaterialType.Linen,
            (int)MaterialType.Wool,
            (int)MaterialType.Velvet,
            (int)MaterialType.Satin,
            (int)MaterialType.Silk
        },
        // Leather
        new int[]
        {
            (int)MaterialType.Leather,
            (int)MaterialType.ArmoredilloHide,
    ...
    public static readonly Dictionary<ArmorTypeWarrior, int[]> armorTypeWarriorMap = new Dictionary<
        ArmorTypeWarrior,
        int[]
    >()
    {
    ...
    public static readonly Dictionary<ArmorTypeCaster, int[]> armorTypeCasterMap = new Dictionary<
        ArmorTypeCaster,
        int[]
    >()
    {
    ...
    public static int GetMeleeSubtypeDamageRange(WeaponSubtype weaponSubtype, int tier)
    {
        ...
        switch (weaponSubtype)
        {
            case WeaponSubtype.AxeLarge:
                return AxeLargeMaxDamage[tier] - AxeLargeMinDamage[tier];
            case WeaponSubtype.AxeMedium:
                return AxeMediumMaxDamage[tier] - AxeMediumMinDamage[tier];
            case WeaponSubtype.AxeSmall:
                return AxeSmallMaxDamage[tier] - AxeSmallMinDamage[tier];
            case WeaponSubtype.DaggerLarge:
                return DaggerLargeMaxDamage[tier] - DaggerLargeMinDamage[tier];
            case WeaponSubtype.DaggerSmall:
                return DaggerSmallMaxDamage[tier] - DaggerSmallMinDamage[tier];
            case WeaponSubtype.MaceLarge:
                return MaceLargeMaxDamage[tier] - MaceLargeMinDamage[tier];
            case WeaponSubtype.MaceMedium:
                return MaceMediumMaxDamage[tier] - MaceMediumMinDamage[tier];
            case WeaponSubtype.MaceSmall:
                return MaceSmallMaxDamage[tier] - MaceSmallMinDamage[tier];
            case WeaponSubtype.SpearLarge:
                return SpearLargeMaxDamage[tier] - SpearLargeMinDamage[tier];
            case WeaponSubtype.SpearMedium:
                return SpearMediumMaxDamage[tier] - SpearMediumMinDamage[tier];
            case WeaponSubtype.SpearSmall:
                return SpearSmallMaxDamage[tier] - SpearSmallMinDamage[tier];
            case WeaponSubtype.StaffLarge:
                return StaffLargeMaxDamage[tier] - StaffLargeMinDamage[tier];
            case WeaponSubtype.StaffMedium:
                return StaffMediumMaxDamage[tier] - StaffMediumMinDamage[tier];
            case WeaponSubtype.StaffSmall:
                return StaffSmallMaxDamage[tier] - StaffSmallMinDamage[tier];
            case WeaponSubtype.SwordLarge:
                return SwordLargeMaxDamage[tier] - SwordLargeMinDamage[tier];
            case WeaponSubtype.SwordMedium:
                return SwordMediumMaxDamage[tier] - SwordMediumMinDamage[tier];
    ...
    public static float GetMissileCasterSubtypeDamageRange(WeaponSubtype weaponSubtype, int tier)
    {
        ...
        switch (weaponSubtype)
        {
            case WeaponSubtype.AtlatlLarge:
                return AtlatlLargeMaxDamageMod[tier] - AtlatlLargeMinDamageMod[tier];
            case WeaponSubtype.AtlatlSmall:
                return AtlatlSmallMaxDamageMod[tier] - AtlatlSmallMinDamageMod[tier];
            case WeaponSubtype.BowLarge:
                return BowLargeMaxDamageMod[tier] - BowLargeMinDamageMod[tier];
            case WeaponSubtype.BowSmall:
                return BowSmallMaxDamageMod[tier] - BowSmallMinDamageMod[tier];
            case WeaponSubtype.CrossbowLarge:
                return CrossbowLargeMaxDamageMod[tier] - CrossbowLargeMinDamageMod[tier];
            case WeaponSubtype.CrossbowSmall:
                return CrossbowSmallMaxDamageMod[tier] - CrossbowSmallMinDamageMod[tier];
