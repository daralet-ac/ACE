...
public static partial class LootGenerationFactory
{
    ...
    private static ChanceTable<int> numSlagChance = new ChanceTable<int>() { (1, 0.65f), (2, 0.25f), (3, 0.10f), };

    private static ChanceTable<bool> rareSlagChance = new ChanceTable<bool>() { (false, 0.95f), (true, 0.05f) };
    ...
    public static WorldObject RollSlag(Player player, bool hadVitae)
    {
        ...
        if (tier < 5)
        {
            return null; // if less than level 100, never drop any slag
        }
