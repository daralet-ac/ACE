...
public class AllegianceManager
{
    ...
    public static readonly Dictionary<ObjectGuid, AllegianceNode> Players =
        new Dictionary<ObjectGuid, AllegianceNode>();
    ...
    /// </summary>
    public static float SkillCap = 263.0f; // TODO Eventually change to 300
    ...
    public static void HandleNoAllegiance(IPlayer player)
    {
        ...
        if (player.AllegianceRank != null)
        {
            ...
            if (onlinePlayer != null)
            {
                onlinePlayer.Session.Network.EnqueueSend(
                    new GameMessagePrivateUpdatePropertyInt(onlinePlayer, PropertyInt.AllegianceRank, 0)
                );
            }
        ...
        {
            onlinePlayer.Session.Network.EnqueueSend(
                new GameEventAllegianceUpdate(
                    onlinePlayer.Session,
                    onlinePlayer.Allegiance,
                    onlinePlayer.AllegianceNode
                ),
