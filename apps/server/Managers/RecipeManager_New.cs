    ...
    public static Recipe GetNewRecipe(Player player, WorldObject source, WorldObject target)
    {
        ...
        switch ((WeenieClassName)source.WeenieClassId)
        {
            ...
            case WeenieClassName.W_MATERIALRAREETERNALIVORY_CLASS:
                ...
                var recipeId =
                    source.WeenieClassId == (int)WeenieClassName.W_MATERIALRAREETERNALIVORY_CLASS ? 9069 : 3977;
            ...
            case WeenieClassName.W_MATERIALRAREETERNALLEATHER_CLASS:
                ...
                recipeId =
                    source.WeenieClassId == (int)WeenieClassName.W_MATERIALRAREETERNALLEATHER_CLASS ? 9070 : 4426;
            ...
            case WeenieClassName.W_LUCKYRABBITSFOOT_CLASS:
                ...
                if (
                    target.WeenieType != WeenieType.MeleeWeapon && target.WeenieType != WeenieType.Missile
                    || target.Workmanship == null
                )
                {
                    return null;
                }
            ...
            case WeenieClassName.W_MATERIALCARNELIAN_CLASS:
                ...
                if (
                    target.WeenieType != WeenieType.Generic
                    || target.Workmanship == null
                    || target.ValidLocations == EquipMask.TrinketOne
                )
                {
                    return null;
                }
            ...
            case WeenieClassName.W_MATERIALCOPPER_CLASS:
                ...
                var allowClothing =
                    ...
                    && (
                        target.ValidLocations == EquipMask.HeadWear
                        || target.ValidLocations == EquipMask.HandWear
                        || target.ValidLocations == EquipMask.FootWear
                    );
            ...
            case WeenieClassName.W_UNINSCRIPTIONSTONE_CLASS:
                ...
                */
                ...
                var inscription = "";
                var baseWeenie = DatabaseManager
                    .World.GetCachedWeenie(target.WeenieClassId)
                    ?.PropertiesString?.TryGetValue(PropertyString.Inscription, out inscription);
