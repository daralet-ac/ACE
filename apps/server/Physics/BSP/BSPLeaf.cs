...
public class BSPLeaf : BSPNode, IEquatable<BSPLeaf>
{
    ...
    public BSPLeaf(BSPTreeType type)
        : base(type) { }

    public BSPLeaf(
        DatLoader.Entity.BSPLeaf node,
    ...
    public override void find_walkable(
        SpherePath path,
        Sphere validPos,
        ref Polygon hitPoly,
        Vector3 movement,
    ...
    public override bool sphere_intersects_poly(
        Sphere checkPos,
        Vector3 movement,
        ref Polygon hitPoly,
    ...
    public override bool sphere_intersects_solid_poly(
        Sphere checkPos,
        float radius,
