...
public class CommandInterpreter
{
    ...
    public bool BookkeepCommandAndModifyIfNecessary(
    ...
    public void MovePlayer(MotionCommand command, bool start, float speed, bool mouse, bool newHoldRun)
    {
        ...
        var start_turn_left = false;
        var start_turn_right = false;
        var start_sidestep_left = false;
        var start_sidestep_right = false;

        var cancel_turn_left = false;
        var cancel_turn_right = false;
        var cancel_sidestep_left = false;
        var cancel_sidestep_right = false;
