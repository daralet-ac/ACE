...
public class TargetManager
{
    ...
    {
        if (PhysicsObj == null || TargetInfo == null)
        {
            return;
        }
    ...
    public void HandleTargetting()
    {
        ...
        if (PhysicsTimer.CurrentTime - LastUpdateTime < 0.5f)
        {
            return;
        }
        ...
        if (
            TargetInfo != null
            && TargetInfo.Status == TargetStatus.Undefined
            && TargetInfo.LastUpdateTime + 10.0f < PhysicsTimer.CurrentTime
        )
        {
    ...
    {
        if (PhysicsObj == null || TargetInfo == null || TargetInfo.ObjectID != update.ObjectID)
        {
            return;
        }
