...
public class Landblock : LandblockStruct
{
    ...
    public void get_land_limits()
    {
        ...
        MinZ = LandDefs.LandHeightTable[
            minHeight
        ] /* + 1.0f*/
        ;
        MaxZ = LandDefs.LandHeightTable[
            maxHeight
        ] /* + 200.0f*/
        ;
    }
    ...
    public void get_land_scenes()
    {
        ...
        for (uint i = 0; i < Terrain.Count; i++)
        {
            ...
            var sceneInfo = (int)
                DatManager.PortalDat.RegionDesc.TerrainInfo.TerrainTypes[terrainType].SceneTypes[sceneType];
    ...
    {
        var x = (int)(obj.X / TileLength);
        var y = (int)(obj.Y / TileLength);

        var rMin = RoadWidth;
        var rMax = TileLength - RoadWidth;
        ...
        var r0 = GetRoad(x0, y0);
        var r1 = GetRoad(x0, y1);
        var r2 = GetRoad(x1, y0);
        var r3 = GetRoad(x1, y1);
        ...
        var dx = obj.X - x * TileLength;
        var dy = obj.Y - y * TileLength;
