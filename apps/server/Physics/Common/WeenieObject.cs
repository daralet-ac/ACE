...
public class WeenieObject
{
    ...
    public bool CanMoveInto(WeenieObject mover)
    {
        ...
        {
            _log.Error(
                $"{WorldObject?.Name} ({WorldObject?.Guid}).CanMoveInto({mover.WorldObject?.Name} ({mover.WorldObject?.Guid}) - couldn't find house"
            );
            return true;
        }
        ...
        {
            _log.Error(
                $"{WorldObject?.Name} ({WorldObject?.Guid}).CanMoveInto({mover.WorldObject?.Name} ({mover.WorldObject?.Guid}) - couldn't find root house"
            );
            return true;
        }
        ...
        {
            _log.Error(
                $"{WorldObject?.Name} ({WorldObject?.Guid}).CanMoveInto({mover.WorldObject?.Name} ({mover.WorldObject?.Guid}) - couldn't find player"
            );
            return true;
        }
