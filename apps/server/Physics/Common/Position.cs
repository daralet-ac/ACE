...
public class Position : IEquatable<Position>
{
    ...
    public static double CylinderDistance(
        float radius,
        float height,
        Position pos,
        float otherRadius,
    ...
    )
    {
        ...
        var diffZ =
            pos.Frame.Origin.Z <= otherPos.Frame.Origin.Z
                ? otherPos.Frame.Origin.Z - (pos.Frame.Origin.Z + height)
    ...
    public static double CylinderDistanceSq(
        float radius,
        float height,
        Position pos,
        float otherRadius,
