...
public class EnvCell : ObjCell, IEquatable<EnvCell>
{
    ...
    public EnvCell(DatLoader.FileTypes.EnvCell envCell)
        : base()
    {
        _envCell = envCell;
    ...
    public void check_building_transit(
        ushort portalId,
        Position pos,
        int numSphere,
        List<Sphere> spheres,
    ...
    public void check_building_transit(int portalId, int numParts, List<PhysicsPart> parts, CellArray cellArray)
    {
        ...
        foreach (var part in parts)
        {
            ...
            if (
                intersect == Sidedness.Crossing
                || intersect == Sidedness.Positive && portal.PortalSide
                || intersect == Sidedness.Negative && !portal.PortalSide
            )
            {
    ...
    public override void find_transit_cells(int numParts, List<PhysicsPart> parts, CellArray cellArray)
    {
        ...
        foreach (var portal in Portals)
        {
            ...
            foreach (var part in parts)
            {
                ...
                if (
                    sidedness == Sidedness.Positive && !portal.PortalSide
                    || sidedness == Sidedness.Negative && portal.PortalSide
                )
                {
                    continue;
                }
    ...
    public override void find_transit_cells(
        Position position,
        int numSphere,
        List<Sphere> spheres,
        CellArray cellArray,
