...
public class PalShift
{
    ...
    public uint SelectRot(
        int x,
        int y,
        ref LandDefs.Rotation rot,
        List<uint> palCode,
        int size,
        uint palID,
        ref int rIndex,
    ...
    {
        var first_tnum =
            (ulong)(1813693831 * y - x * (1647165151 * y + 1109124029) - 2031889191) * 2.3283064e-10 * LandTex.Count;
        var tnum = first_tnum;
    ...
    public LandDefs.Rotation GetBeginRotation(int x, int y, List<uint> pCode, bool minimizePal)
    {
        ...
        var rotIdx = (ulong)(1813693831 * y - x * (501661475 * y + 1109124029) + 1225298869) * 2.3283064e-10 * 4;
