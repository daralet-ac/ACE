...
public class PacketInboundLoginRequest
{
    ...
    public PacketInboundLoginRequest(ClientPacket packet)
    {
        ...
        var len = packet.DataReader.ReadUInt32(); // data length left in packet including ticket
        ...
        var accountToLoginAs = packet.DataReader.ReadString16L(); // special admin only, AuthFlags has 2
