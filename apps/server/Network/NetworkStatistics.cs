...
{
    private static readonly Lazy<NetworkStatistics> lazy = new Lazy<NetworkStatistics>(() => new NetworkStatistics());
    ...
    public static long C2S_RequestsForRetransmit_Aggregate_Increment()
    {
        return Interlocked.Increment(ref Instance._C2S_RequestsForRetransmit_Aggregate);
    }
    ...
    public static long S2C_RequestsForRetransmit_Aggregate_Increment()
    {
        return Interlocked.Increment(ref Instance._S2C_RequestsForRetransmit_Aggregate);
    }
    ...
    public static long C2S_CRCErrors_Aggregate_Increment()
    {
        return Interlocked.Increment(ref Instance._C2S_CRCErrors_Aggregate);
    }
    ...
    public static long C2S_Packets_Aggregate_Increment()
    {
        return Interlocked.Increment(ref Instance._C2S_Packets_Aggregate);
    }
    ...
    public static long S2C_Packets_Aggregate_Increment()
    {
        return Interlocked.Increment(ref Instance._S2C_Packets_Aggregate);
    }

    public static string Summary()
    {
        var rfr_s2c_Proportion =
            (Instance._S2C_Packets_Aggregate < 1)
                ? 0
                : (double)Instance._S2C_RequestsForRetransmit_Aggregate / Instance._S2C_Packets_Aggregate;
        var rfr_c2s_Proportion =
            (Instance._C2S_Packets_Aggregate < 1)
                ? 0
                : (double)Instance._C2S_RequestsForRetransmit_Aggregate / Instance._C2S_Packets_Aggregate;
        var crce_c2s_Proportion =
            (Instance._C2S_Packets_Aggregate < 1)
                ? 0
                : (double)Instance._C2S_CRCErrors_Aggregate / Instance._C2S_Packets_Aggregate;
