...
{
    public GameEventChannelBroadcast(Session session, Channel chatChannel, string senderName, string messageText)
        : base(GameEventType.ChannelBroadcast, GameMessageGroup.UIQueue, session)
    {
