...
public class GameEventFriendsListUpdate : GameEventMessage
{
    ...
    public GameEventFriendsListUpdate(
        Session session,
        FriendsUpdateTypeFlag updateType,
        CharacterPropertiesFriendList friend,
        bool overrideOnlineStatus = false,
        bool onlineStatusVal = false
    )
    ...
    private void WriteEventBody()
    {
        ...
        foreach (var f in friendList)
        {
            ...
            Writer.Write(
                (uint)0 /* TODO player.Character.CharacterPropertiesFriendList.Count*/
            );
            ...
            Writer.Write(
                (uint)0 /* TODO playersFriend.Character.CharacterPropertiesFriendList.Count*/
            );
