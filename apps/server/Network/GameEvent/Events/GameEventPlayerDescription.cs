...
public class GameEventPlayerDescription : GameEventMessage
{
    ...
    private void WriteEventBody()
    {
        ...
        if (_propertiesDouble.Count != 0)
        {
            ...
            var propertiesDouble = new SortedDictionary<PropertyFloat, double>(
                _propertiesDouble,
                PropertyDoubleComparer
            );
        ...
        if (_propertiesString.Count != 0)
        {
            ...
            var propertiesString = new SortedDictionary<PropertyString, string>(
                _propertiesString,
        ...
        if (_propertiesIid.Count != 0)
        {
            ...
            var propertiesIid = new SortedDictionary<PropertyInstanceId, uint>(
                _propertiesIid,
        ...
        foreach (
            var item in Session.Player.Inventory.Values.Where(i => !i.UseBackpackSlot).OrderBy(i => i.PlacementPosition)
        )
        {
