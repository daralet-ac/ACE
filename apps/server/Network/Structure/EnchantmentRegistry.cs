...
public class EnchantmentRegistry
{
    ...
    private static Dictionary<EnchantmentMask, List<Enchantment>> BuildCategories(
        Player player,
        ICollection<PropertiesEnchantmentRegistry> registry
    )
    {
        ...
        foreach (var entry in registry)
        {
            ...
            else
            {
                ...
                {
                    Console.WriteLine(
                        $"EnchantmentRegistry.BuildCategories(): unknown enchantment {enchantment.SpellID} StatModType {enchantment.StatModType}"
                    );
                }
