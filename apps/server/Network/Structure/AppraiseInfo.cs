...
public class AppraiseInfo
{
    ...
    private void AddPropertyEnchantments(WorldObject wo)
    {
        ...
        SetGearRatingText(PropertyInt.GearRedFury, "Red Fury", $"Grants increased damage as your health falls below 50%, up to a maximum bonus of (ONE)% at 25% HP. Above 50% Health, you receive a damage reduction penalty scaling up to (ONE)% at full HP.");
