    ...
    public static void Write(this BinaryWriter writer, AllegianceHierarchy hierarchy)
    {
        ...
        if (allegiance != null && node != null)
        {
            ...
            if (recordCount > 1)
            {
                ...
                {
                    records.Add(
                        new Tuple<ObjectGuid, AllegianceData>(node.Monarch.PlayerGuid, new AllegianceData(node.Patron))
                    );
                }
                ...
                {
                    records.Add(
                        new Tuple<ObjectGuid, AllegianceData>(node.Patron.PlayerGuid, new AllegianceData(node))
                    );
                }
