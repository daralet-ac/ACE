...
public static class ResistMaskHelper
{
    ...
    {
        var wielderManaConvMod =
            weapon?.Wielder != null && weapon.IsEnchantable ? weapon.Wielder.EnchantmentManager.GetManaConvMod() : 1.0f;
    ...
    {
        var wielderElementalDamageMod =
            weapon?.Wielder != null && weapon.IsEnchantable
                ? weapon.Wielder.EnchantmentManager.GetElementalDamageMod()
                : 0.0f;
