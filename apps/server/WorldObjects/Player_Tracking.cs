...
partial class Player
{
    ...
    {
        return ObjMaint
            .GetKnownObjectsValuesWhere(i => i?.WeenieObj.WorldObject != null)
            .Select(o => o.WeenieObj.WorldObject)
            .ToList();
    }
    ...
    {
        var addedKnownObj = ObjMaint.AddKnownObject(worldObject.PhysicsObj);
        var addedVisibleObj = ObjMaint.AddVisibleObject(worldObject.PhysicsObj);
