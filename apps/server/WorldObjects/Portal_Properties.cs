...
partial class Portal
{
    public PortalBitmask PortalRestrictions
    {
        ...
        set
        {
            ...
            {
                RemoveProperty(PropertyInt.PortalBitmask);
            }
            else
            {
                SetProperty(PropertyInt.PortalBitmask, (int)value);
            }
        }
    }
    ...
    public uint? OriginalPortal
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyDataId.OriginalPortal);
            }
            else
            {
                SetProperty(PropertyDataId.OriginalPortal, value.Value);
            }
        }
    }
    ...
    public bool? PortalShowDestination
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyBool.PortalShowDestination);
            }
            else
            {
                SetProperty(PropertyBool.PortalShowDestination, value.Value);
            }
        }
    }
    ...
    public string AppraisalPortalDestination
    {
        ...
        set
        {
            if (value == null)
            {
                RemoveProperty(PropertyString.AppraisalPortalDestination);
            }
            else
            {
                SetProperty(PropertyString.AppraisalPortalDestination, value);
            }
        }
    }
    ...
    public bool PortalIgnoresPkAttackTimer
    {
        ...
        set
        {
            if (!value)
            {
                RemoveProperty(PropertyBool.PortalIgnoresPkAttackTimer);
            }
            else
            {
                SetProperty(PropertyBool.PortalIgnoresPkAttackTimer, value);
            }
        }
    }
    ...
    public bool? AdvocateQuest
    {
        ...
        set
        {
            ...
            {
                SetProperty(PropertyBool.AdvocateQuest, value.Value);
            }
        }
    }
}
