...
public static class ProjectileCollisionHelper
{
    public static void OnCollideObject(WorldObject worldObject, WorldObject target)
    {
        ...
        if (targetCreature != null && targetCreature.IsAlive)
        {
            ...
            else if (sourceCreature != null && sourceCreature.AttackTarget != null)
            {
                ...
                if (targetPlayer != null)
                {
                    ...
                    if (damageEvent.HasDamage)
                    {
                        ...
                        if (
                            sourceCreature.GetCreatureSkill(Skill.DirtyFighting).AdvancementClass
            ...
            if (damageEvent != null && damageEvent.HasDamage)
            {
                ...
                if (LandblockManager.CurrentlyTickingLandblockGroupsMultiThreaded)
                {
                    ...
                    if (
                        worldObject.CurrentLandblock == null
                        || sourceCreature.CurrentLandblock == null
                        || targetCreature.CurrentLandblock == null
                        || worldObject.CurrentLandblock.CurrentLandblockGroup
                            != sourceCreature.CurrentLandblock.CurrentLandblockGroup
                        || sourceCreature.CurrentLandblock.CurrentLandblockGroup
                            != targetCreature.CurrentLandblock.CurrentLandblockGroup
                    )
                    {
                        threadSafe = false;
                    }
                ...
                if (threadSafe)
                {
                    ...
                    worldObject.TryProcEquippedItems(
                        sourceCreature,
                        targetCreature,
                        false,
                        worldObject.ProjectileLauncher
                    );
                }
                else
                {
        ...
        worldObject.CurrentLandblock?.RemoveWorldObject(
            worldObject.Guid,
            showError: !worldObject.PhysicsObj.entering_world
        );
