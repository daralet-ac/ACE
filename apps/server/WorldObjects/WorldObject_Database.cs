...
partial class WorldObject
{
    ...
    public bool IsDynamicThatShouldPersistToShard()
    {
        ...
        {
            _log.Warning(
                "Missile: WeenieClassId: {WeenieClassId}, Name: {WeenieName}, WeenieType: {WeenieType}, detected in IsDynamicThatShouldPersistToShard() that wasn't caught by prior check.",
                WeenieClassId,
                Name,
                WeenieType
            );
