...
partial class WorldObject
{
    ...
    public long? ItemBaseXp
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyInt64.ItemBaseXp);
            }
            else
            {
                SetProperty(PropertyInt64.ItemBaseXp, value.Value);
            }
        }
    }
    ...
    public int? ItemMaxLevel
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyInt.ItemMaxLevel);
            }
            else
            {
                SetProperty(PropertyInt.ItemMaxLevel, value.Value);
            }
        }
    }
    ...
    public long? ItemTotalXp
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyInt64.ItemTotalXp);
            }
            else
            {
                SetProperty(PropertyInt64.ItemTotalXp, value.Value);
            }
        }
    }
    ...
    public ItemXpStyle? ItemXpStyle
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyInt.ItemXpStyle);
            }
            else
            {
                SetProperty(PropertyInt.ItemXpStyle, (int)value.Value);
            }
        }
    }
    ...
    public EquipmentSet? EquipmentSetId
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyInt.EquipmentSetId);
            }
            else
            {
                SetProperty(PropertyInt.EquipmentSetId, (int)value.Value);
            }
        }
    }
    ...
    public int? ItemLevel
    {
        get
        {
            ...
            return ExperienceSystem.ItemTotalXPToLevel(
                (ulong)ItemTotalXp.Value,
                (ulong)ItemBaseXp.Value,
                ItemMaxLevel.Value,
                ItemXpStyle.Value
            );
        }
