    ...
    partial class Player
    {
        ...
        public void RechargeEmpoweredScarabs(Hotspot manaField)
        {
            ...
            if (manaField.Tier == 0) // Low
            {
                ...
                foreach (EmpoweredScarab empoweredScarab in equippedEmpoweredScarabs)
                {
        ...
        public void CheckForEmpoweredScarabOnCastEffects(WorldObject target, Spell spell, bool isWeaponSpell, Creature creatureToCastSpellFrom = null, bool onCrit = false)
        {
            var equippedEmpoweredScarabs = GetEquippedEmpoweredScarabs();
            if (equippedEmpoweredScarabs.Count < 1)
                return;
        ...
        /// </summary>
        public EmpoweredScarab CheckForReadyEmpoweredScarabEffects(List<EmpoweredScarab> equippedEmpoweredScarabs, WorldObject target, Spell spell, bool isWeaponSpell, Creature creatureToCastSpellFrom = null, bool onCrit = false)
        {
            List<EmpoweredScarabEffect> effectsUsed = new List<EmpoweredScarabEffect>();
            ...
            foreach (EmpoweredScarab empoweredScarab in equippedEmpoweredScarabs)
            {
                ...
                EmpoweredScarabEffect effect = (EmpoweredScarabEffect)empoweredScarab.EmpoweredScarabEffectId;
        ...
        private void StartEmpoweredScarabEffect(EmpoweredScarab empoweredScarab)
        {
            switch ((EmpoweredScarabEffect)empoweredScarab.EmpoweredScarabEffectId)
            {
                ...
                case EmpoweredScarabEffect.Intensity:
                    ...
                    Session.Network.EnqueueSend(new GameMessageSystemChat($"Empowered Scarab of Intensity increased the spell's intensity by {Math.Round((empoweredScarab.EmpoweredScarabIntensity ?? 1) * 100, 0)}%!", ChatMessageType.Magic));
                    break;
        ...
        private void CastEmpoweredScarabSpell(EmpoweredScarab empoweredScarab, bool useProgression = true)
        {
            ...
            if (empoweredScarab.EmpoweredScarabEffectId == (int)EmpoweredScarabEffect.CastVitalRate)
            {
                ...
                {
                    case SpellCategory.HealthRaising: castSpellLevel1Id = SpellId.RegenerationOther1; break;
                    case SpellCategory.HealingRaising: castSpellLevel1Id = SpellId.RegenerationOther1; break;
                    case SpellCategory.StaminaRaising: castSpellLevel1Id = SpellId.RejuvenationOther1; break;
                    case SpellCategory.ManaRaising: castSpellLevel1Id = SpellId.ManaRenewalOther1; break;
            ...
            else if (empoweredScarab.EmpoweredScarabEffectId == (int)EmpoweredScarabEffect.CastItemBuff)
            {
                switch (empoweredScarab.TriggerSpell.Category)
                {
                    case SpellCategory.HealthRaising: castSpellLevel1Id = SpellId.DefenderOther1; break;
                    case SpellCategory.HealingRaising: castSpellLevel1Id = SpellId.DefenderOther1; break;
                    case SpellCategory.StaminaRaising: castSpellLevel1Id = SpellId.BloodDrinkerOther1; break;
                    case SpellCategory.ManaRaising: castSpellLevel1Id = SpellId.SpiritDrinkerOther1; break;
                    //case SpellCategory.HealthLowering: castSpellLevel1Id = SpellId.FesterOther1; break;
                    //case SpellCategory.StaminaLowering: castSpellLevel1Id = SpellId.ExhaustionOther1; break;
                    //case SpellCategory.ManaLowering: castSpellLevel1Id = SpellId.ManaDepletionOther1; break;
                    default: return;
            ...
            if (useProgression)
            {
                castSpellId = SpellLevelProgression.GetSpellAtLevel(castSpellLevel1Id, (int)empoweredScarab.SpellLevel, true);
        ...
        private uint? DetonateSpellId(Spell spell)
        {
            ...
            switch (element)
            {
                case DamageType.Slash: return (uint)SpellId.BladeRing;
                case DamageType.Pierce: return (uint)SpellId.ForceRing;
                case DamageType.Bludgeon: return (uint)SpellId.ShockwaveRing;
                case DamageType.Acid: return (uint)SpellId.AcidRing;
                case DamageType.Fire: return (uint)SpellId.FlameRing;
                case DamageType.Cold: return (uint)SpellId.FrostRing;
                case DamageType.Electric: return (uint)SpellId.LightningRing;
            }
        ...
        private bool EmpoweredScarabValidationChecks(EmpoweredScarab empoweredScarab, Spell spell, List<EmpoweredScarabEffect> effectsUsed, Creature creatureTarget = null, bool onCrit = false)
        {
            // CHECK FOR NULL and EFFECT ID
            if (empoweredScarab == null || effectsUsed.Contains((EmpoweredScarabEffect)empoweredScarab.EmpoweredScarabEffectId))
                return false;
        ...
        {
            return (EmpoweredScarab.LifeBeneficialTriggerSpells.Contains(spell.Category) || EmpoweredScarab.LifeHarmfulTriggerSpells.Contains(spell.Category)) && !onCrit;
        }
        ...
        {
            return EmpoweredScarab.WarProjectileTriggerCategories.Contains(spell.Category) && empoweredScarab.EmpoweredScarabMaxLevel >= spell.Level && !onCrit;
        }

        private bool IsValidForDetonate(Spell spell, EmpoweredScarab empoweredScarab, Creature creatureTarget = null, bool onCrit = false)
        {
            return creatureTarget != null && EmpoweredScarab.WarProjectileTriggerCategories.Contains(spell.Category) && empoweredScarab.EmpoweredScarabMaxLevel >= spell.Level && !onCrit;
        }
