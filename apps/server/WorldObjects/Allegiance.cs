...
public class Allegiance : WorldObject
{
    ...
    public Dictionary<uint, PropertiesAllegiance> ApprovedVassals =>
        Biota.PropertiesAllegiance.GetApprovedVassals(BiotaDatabaseLock);
    ...
    /// </summary>
    public Allegiance(Weenie weenie, ObjectGuid guid)
        : base(weenie, guid)
    {
    ...
    {
        Officers = Members
            .Where(i => i.Value.Player.AllegianceOfficerRank != null)
    ...
    public string AllegianceName
    {
        ...
        set
        {
            if (value == null)
            {
                RemoveProperty(PropertyString.AllegianceName);
            }
            else
            {
                SetProperty(PropertyString.AllegianceName, value);
            }
        }
    }
    ...
    public string AllegianceMotd
    {
        ...
        set
        {
            if (value == null)
            {
                RemoveProperty(PropertyString.AllegianceMotd);
            }
            else
            {
                SetProperty(PropertyString.AllegianceMotd, value);
            }
        }
    }
    ...
    public string AllegianceMotdSetBy
    {
        ...
        set
        {
            if (value == null)
            {
                RemoveProperty(PropertyString.AllegianceMotdSetBy);
            }
            else
            {
                SetProperty(PropertyString.AllegianceMotdSetBy, value);
            }
        }
    }
    ...
    public string AllegianceSpeakerTitle
    {
        ...
        set
        {
            if (value == null)
            {
                RemoveProperty(PropertyString.AllegianceSpeakerTitle);
            }
            else
            {
                SetProperty(PropertyString.AllegianceSpeakerTitle, value);
            }
        }
    }
    ...
    public string AllegianceSeneschalTitle
    {
        ...
        set
        {
            if (value == null)
            {
                RemoveProperty(PropertyString.AllegianceSeneschalTitle);
            }
            else
            {
                SetProperty(PropertyString.AllegianceSeneschalTitle, value);
            }
        }
    }
    ...
    public string AllegianceCastellanTitle
    {
        ...
        set
        {
            if (value == null)
            {
                RemoveProperty(PropertyString.AllegianceCastellanTitle);
            }
            else
            {
                SetProperty(PropertyString.AllegianceCastellanTitle, value);
            }
        }
    }
    ...
    public bool HasCustomTitles =>
        AllegianceSpeakerTitle != null || AllegianceSeneschalTitle != null || AllegianceCastellanTitle != null;
    ...
    public void UpdateProperties()
    {
        foreach (var member in Members)
        {
            ...
            {
                onlinePlayer.Session.Network.EnqueueSend(
                    new GameEventAllegianceUpdate(onlinePlayer.Session, this, member.Value),
                    new GameEventAllegianceAllegianceUpdateDone(onlinePlayer.Session)
                );
            }
        }
    }
    ...
    public void ShowMembers()
    {
        ...
        foreach (var member in Members)
        {
            var player = PlayerManager.FindByGuid(member.Key, out var isOnline);
            var prefix = isOnline ? "* " : "";
    ...
    public void AddBan(uint playerGuid)
    {
        ...
        {
            Biota.PropertiesAllegiance.AddOrUpdateAllegiance(
                playerGuid,
                true,
                entity.ApprovedVassal,
                BiotaDatabaseLock
            );
        }
