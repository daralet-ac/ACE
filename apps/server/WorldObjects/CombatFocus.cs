            ...
            if (combatAbilityId != null)
            {
                switch ((CombatAbility)combatAbilityId)
                {
                    case CombatAbility.Phalanx:
                        description += "With this focus equipped, your shield will reduce damage from all sides, and your enemies cannot make sneak attacks against you.\n\n" +
                    ...
                    case CombatAbility.Provoke:
                        description += "With this focus equipped, increase the threat you generate with your attacks by 20%. All glancing blows against are always major.\n\n" +
                    ...
                    case CombatAbility.Parry:
                        description += "With this focus equipped, to gain a 20% chance to block attacks while using a two-handed weapon or dual-wielding.\n\n" +
                    ...
                    case CombatAbility.Fury:
                        description += "With this focus equipped, attacks you make in melee range build Fury. As Fury increases, your damage receives a bonus, up to a maximum of 25%. " +
                    ...
                    case CombatAbility.Backstab:
                        description += "With this focus equipped, your chance to deal a critical hit is increased by 20% while performing sneak attacks. Normal hits deal 20% less damage.\n\n" +
                            "Activated Combat Ability: For the next 10 seconds, your attacks from behind cannot be evaded\n\n"; break;
                    case CombatAbility.SteadyShot:
                        description += "With this focus equipped, the accuracy of your missile weapon attacks is increased by 20%.\n\n" +
                    ...
                    case CombatAbility.Smokescreen:
                        description += "With this focus equipped, gain 10% increased chance to evade attacks, and make enemies less likely to attack you. Other targets for the enemy must be available.\n\n" +
                    ...
                    case CombatAbility.Multishot:
                        description += "With this focus equipped, to shoot an extra arrow, quarrel or dart at another monster near your main target, if there are any. Your damage is reduced by 75%.\n\n" +
                    ...
                    case CombatAbility.Overload:
                        description += "With this focus equipped, your spells build Overload. As Overload increases, so does your spell effectiveness up to a maximum of 25%. " +
                    ...
                    case CombatAbility.Battery:
                        description += "With this focus equipped, your mana costs are reduced by 20%, the reduction increasing as your mana pool is depleted. However, below 75% mana, your spell effectiveness also begins to decrease to as little as 25% at 0 mana.\n\n" +
                    ...
                    case CombatAbility.Reflect:
                        description += "While equipped, you will reflect fully resisted spells back at the caster. Additionally, gain 20% increased Magic Defense while attempting to resist a spell.\n\n" +
                    ...
                    case CombatAbility.EnchantedWeapon:
                        description += "With this focus equipped, you have a 100% chance to trigger Cast-on-strike spells while attacking at full power/accuracy. " +
