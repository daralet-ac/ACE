...
partial class Player
{
    ...
    public void CreateMoveToChain2(
        WorldObject target,
    ...
    public void CreateTurnToChain2(
        WorldObject target,
        Action<bool> callback,
        float? useRadius = null,
        bool stopCompletely = false,
        bool alwaysTurn = false
    )
    {
        if (IsPlayerMovingTo2)
        {
    ...
    public void HandleMoveToCallback()
    {
        ...
        var withinUseRadius =
            MoveToParams.UseRadius == null
            || CurrentLandblock.WithinUseRadius(this, MoveToParams.Target.Guid, out _, MoveToParams.UseRadius);
