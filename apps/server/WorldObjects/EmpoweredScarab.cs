...
public class EmpoweredScarab : WorldObject
{
    ...
    public int? EmpoweredScarabColor
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyInt.EmpoweredScarabColor);
            }
            else
            {
                SetProperty(PropertyInt.EmpoweredScarabColor, value.Value);
            }
        }
    }
    ...
    public int? EmpoweredScarabSchool
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyInt.EmpoweredScarabSchool);
            }
            else
            {
                SetProperty(PropertyInt.EmpoweredScarabSchool, value.Value);
            }
        }
    }
    ...
    public int? EmpoweredScarabEffectId
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyInt.EmpoweredScarabEffectId);
            }
            else
            {
                SetProperty(PropertyInt.EmpoweredScarabEffectId, value.Value);
            }
        }
    }
    ...
    public int? EmpoweredScarabMaxLevel
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyInt.EmpoweredScarabMaxLevel);
            }
            else
            {
                SetProperty(PropertyInt.EmpoweredScarabMaxLevel, value.Value);
            }
        }
    }
    ...
    public uint? EmpoweredScarabTriggerSpellId
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyDataId.EmpoweredScarabTriggerSpellId);
            }
            else
            {
                SetProperty(PropertyDataId.EmpoweredScarabTriggerSpellId, value.Value);
            }
        }
    }
    ...
    public uint? EmpoweredScarabCastSpellId
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyDataId.EmpoweredScarabCastSpellId);
            }
            else
            {
                SetProperty(PropertyDataId.EmpoweredScarabCastSpellId, value.Value);
            }
        }
    }
    ...
    public double? EmpoweredScarabTriggerChance
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyFloat.EmpoweredScarabTriggerChance);
            }
            else
            {
                SetProperty(PropertyFloat.EmpoweredScarabTriggerChance, value.Value);
            }
        }
    }
    ...
    public double? EmpoweredScarabManaReserved
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyFloat.EmpoweredScarabManaReserved);
            }
            else
            {
                SetProperty(PropertyFloat.EmpoweredScarabManaReserved, value.Value);
            }
        }
    }
    public double? EmpoweredScarabReductionAmount
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyFloat.EmpoweredScarabReductionAmount);
            }
            else
            {
                SetProperty(PropertyFloat.EmpoweredScarabReductionAmount, value.Value);
            }
        }
    }
    ...
    public double? EmpoweredScarabIntensity
    {
        ...
        set
        {
            if (!value.HasValue)
            {
                RemoveProperty(PropertyFloat.EmpoweredScarabIntensity);
            }
            else
            {
                SetProperty(PropertyFloat.EmpoweredScarabIntensity, value.Value);
            }
        }
    }
    ...
    /// </summary>
    public EmpoweredScarab(Weenie weenie, ObjectGuid guid)
        : base(weenie, guid)
    {
        SetEphemeralValues();
    }
    ...
    /// </summary>
    public EmpoweredScarab(Biota biota)
        : base(biota)
    {
        SetEphemeralValues();
    }
    ...
    private void IncreaseStructure(int amount, Player player)
    {
        ...
        if (player != null)
        {
            player.Session.Network.EnqueueSend(
                new GameMessagePublicUpdatePropertyInt(this, PropertyInt.Structure, (int)Structure)
            );
        }
        ...
        if (Structure < MaxStructure)
        {
            ...
            {
                player.Session.Network.EnqueueSend(
                    new GameMessageSystemChat($"Your mana scarab gains a charge!", ChatMessageType.Magic)
                );
            ...
            if (isWielded)
            {
                player.Session.Network.EnqueueSend(
                    new GameMessageSystemChat(
                        $"Your mana scarab gains a charge, it is now fully charged!",
