...
--
-- Host: localhost    Database: ace_auth_timeline
-- ------------------------------------------------------
...
--
-- Current Database: `ace_auth_timeline`
--

/*!40000 DROP DATABASE IF EXISTS `ace_auth_timeline`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `ace_auth_timeline` /*!40100 DEFAULT CHARACTER SET utf8mb4 */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `ace_auth_timeline`;
...
/*
-- Query: SELECT * FROM ace_auth_timeline.accesslevel
